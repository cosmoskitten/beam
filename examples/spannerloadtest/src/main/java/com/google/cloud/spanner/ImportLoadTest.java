...
public class ImportLoadTest implements Serializable {
  ...
  public static void main(String[] args) {
    ...
    PCollection<Integer> lines = p.apply(Create.of(ContiguousSet.create(Range.closedOpen(0, options
            .getNumberOfShards()),
  ...
  private static class GenerateMutations extends DoFn<Integer, Mutation> {
    ...
    public GenerateMutations(String table, long numMutations, int numShards, int numFields, int
        size) {
      this.table = table;
