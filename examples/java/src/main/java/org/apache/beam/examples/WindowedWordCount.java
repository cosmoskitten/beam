...
public class WindowedWordCount {
  ...
  public static class DefaultToMinTimestampPlusOneHour implements DefaultValueFactory<Long> {
    @Override
    public Long create(PipelineOptions options) {
      return options.as(Options.class).getMinTimstampMillis() +
  ...
  public static void main(String[] args) throws IOException {
    ...
    final Instant minTimestamp = new Instant(options.getMinTimstampMillis());
    final Instant maxTimestamp = new Instant(options.getMaxTimstampMillis());
