 ...
 *
 * <p>
 * This class, {@link MinimalWordCountLocal}, is the first in a series of four successively more detailed 'word count'
 * examples. Here, for simplicity, we don't show any error-checking or argument processing, and focus on construction of
 * the pipeline, which chains together the application of core transforms.
 *
 * <p>
 * Next, see the {@link WordCount} pipeline, then the {@link DebuggingWordCount}, and finally the
 * {@link WindowedWordCount} pipeline, for more detailed examples that introduce additional concepts.
 *
 * <p>
 * Concepts:
 * 
 ...
 *
 * <p>
 * To execute this pipeline, first edit the code to set your project ID, the temp location, and the output location. The
 * specified GCS bucket(s) must already exist.
 *
 * <p>
 * Then, run the pipeline as described in the README. It will be deployed and run with the selected runner. No args are
 * required to run the pipeline. You can see the results in your output bucket in the GCS browser.
 */
public class LocalMinimalWordCount {
    ...
    public static void main(String[] args) {
        ...
        p.apply(TextIO.Read.from("/tmp/beam/input/*"))
                ...
                .apply(TextIO.Write.to("/tmp/beam/output/"));
