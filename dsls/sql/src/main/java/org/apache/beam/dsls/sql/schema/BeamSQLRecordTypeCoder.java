...
public class BeamSQLRecordTypeCoder extends CustomCoder<BeamSQLRecordType> {
  ...
  @Override
  public void encode(BeamSQLRecordType value, OutputStream outStream) throws IOException {
  ...
  @Override
  public BeamSQLRecordType decode(InputStream inStream) throws IOException {
