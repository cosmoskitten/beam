 ...
 */
public class BeamSqlDslBoundedProjectTest extends BeamSqlDslBase {
  /**
   * select all fields.
   */
  @Test
  public void testSelectAll() throws Exception {
    ...
    PCollection<BeamSqlRow> result =
        boundedInput2.apply("testSelectAll", BeamSql.simpleQuery(sql));
  ...
  public void testPartialFields() throws Exception {
    ...
    PCollection<BeamSqlRow> result =
        PCollectionTuple.of(new TupleTag<BeamSqlRow>("TABLE_A"), boundedInput2)
