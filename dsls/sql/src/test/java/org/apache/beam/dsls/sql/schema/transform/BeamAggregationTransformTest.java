...
/**
 * Unit tests for {@link BeamAggregationTransform}.
 *
 */
public class BeamAggregationTransformTest extends BeamTransformBaseTest{
  ...
  public void testCountPerElementBasic() throws ParseException {
    ...
    PCollection<KV<BeamSQLRow, BeamSQLRow>> exGroupByStream = input.apply("exGroupBy",
        WithKeys
            .of(new BeamAggregationTransform.AggregationGroupByKeyFn(-1, ImmutableBitSet.of(0))));
    ...
    PCollection<KV<BeamSQLRow, BeamSQLRow>> aggregatedStream = groupedStream.apply("aggregation",
        Combine.<BeamSQLRow, BeamSQLRow, BeamSQLRow>groupedValues(
            new BeamAggregationTransform.AggregationCombineFn(aggCalls, inputRowType)));
  ...
  /**
   * expected results after {@link BeamAggregationTransform.AggregationGroupByKeyFn}.
   */
  ...
  /**
   * expected results after {@link BeamAggregationTransform.AggregationCombineFn}.
   */
  ...
  /**
   * expected results after {@link BeamAggregationTransform.MergeAggregationRecord}.
   */
