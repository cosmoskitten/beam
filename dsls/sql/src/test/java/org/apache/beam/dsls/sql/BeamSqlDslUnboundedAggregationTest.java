 ...
 * with UNBOUNDED PCollection.
 */
public class BeamSqlDslUnboundedAggregationTest extends BeamSqlDslBase {
  /**
  ...
  public void testAggregationWithoutWindow() throws Exception {
    ...
    PCollection<BeamSqlRow> result =
        unboundedInput1.apply("testAggregationWithoutWindow", BeamSql.simpleQuery(sql));
  ...
  public void testDistinct() throws Exception {
    ...
    PCollection<BeamSqlRow> result =
        unboundedInput1.apply("testDistinct", BeamSql.simpleQuery(sql));
  ...
  public void testHopWindow() throws Exception {
    ...
    PCollection<BeamSqlRow> result =
        unboundedInput1.apply("testHopWindow", BeamSql.simpleQuery(sql));
