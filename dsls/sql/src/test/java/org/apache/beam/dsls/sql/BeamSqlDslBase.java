  ...
  public static void prepareClass() throws ParseException {
    RelProtoDataType protoRowType = new RelProtoDataType() {
      ...
      public RelDataType apply(RelDataTypeFactory a0) {
        return a0.builder()
            .add("f_int", SqlTypeName.INTEGER)
            .add("f_long", SqlTypeName.BIGINT)
            .add("f_short", SqlTypeName.SMALLINT)
            .add("f_byte", SqlTypeName.TINYINT)
            .add("f_float", SqlTypeName.FLOAT)
            .add("f_double", SqlTypeName.DOUBLE)
            .add("f_string", SqlTypeName.VARCHAR)
            .add("f_timestamp", SqlTypeName.TIMESTAMP)
            .add("f_int2", SqlTypeName.INTEGER)
            .build();
      }
    };
    recordTypeInTableA = BeamSqlRecordType.from(
