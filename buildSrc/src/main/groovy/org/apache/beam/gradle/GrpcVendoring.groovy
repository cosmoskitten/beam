...
class GrpcVendoring {
  ...
  static Map<String, String> relocations() {
    ...
    return [
      ...
      "com.google.gson": "${prefix}.com.google.gson",
      "io.grpc": "${prefix}.io.grpc",
      "com.google.auth": "${prefix}.com.google.auth",
      "com.google.api": "${prefix}.com.google.api",
      "com.google.cloud": "${prefix}.com.google.cloud",
      "com.google.logging": "${prefix}.com.google.logging",
      "com.google.longrunning": "${prefix}.com.google.longrunning",
      "com.google.rpc": "${prefix}.com.google.rpc",
      "com.google.type": "${prefix}.com.google.type",
      "io.opencensus": "${prefix}.io.opencensus",

      // Adapted from https://github.com/grpc/grpc-java/blob/e283f70ad91f99c7fee8b31b605ef12a4f9b1690/netty/shaded/build.gradle#L41
      "io.netty": "${prefix}.io.netty",
