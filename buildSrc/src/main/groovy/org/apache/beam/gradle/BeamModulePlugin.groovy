...
''')
    ...
    project.ext.applyPythonNature = {
      ...
      project.ext.envdir = "${project.rootDir}/${project.name}/gradleenv"
      ...
      project.task('setupVirtualenv')  {
        doLast {
          ...
          project.exec {
            executable 'sh'
            args '-c', ". \$WORKSPACE/${project.name}/gradleenv/bin/activate && pip install --upgrade tox==3.0.0 grpcio-tools==1.3.5"
          }
        }
...
/home/jenkins/jenkins-slave/workspace/beam_PreCommit_Python_Commit/src/build/beam-sdks-python/gradleenv
/home/jenkins/jenkins-slave/workspace/beam_PreCommit_Python_Commit/src/build/beam-sdks-python-precommit-dataflow/gradleenv