...
''')
    ...
    project.ext.applyPythonNature = {
      ...
      // virtualenv activated properly. So instead of using build directory of the
      // subproject, we put all in build directory of root with fixed length of random
      // string as path suffix.
      project.ext.envdir = "${project.rootProject.buildDir}/gradleenv/${randomGenerator(15)}"
