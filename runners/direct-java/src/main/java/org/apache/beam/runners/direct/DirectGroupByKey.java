...
class DirectGroupByKey<K, V>
  ...
  static final class DirectGroupByKeyOnly<K, V>
      extends PTransforms.RawPTransform<
          PCollection<KV<K, V>>, PCollection<KeyedWorkItem<K, V>>, Void> {
    @Override
  ...
  static final class DirectGroupAlsoByWindow<K, V>
      extends PTransforms.RawPTransform<PCollection<KeyedWorkItem<K, V>>, PCollection<KV<K, Iterable<V>>>, Void> {
