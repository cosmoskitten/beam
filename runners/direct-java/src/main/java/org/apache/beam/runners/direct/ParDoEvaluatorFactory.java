...
final class ParDoEvaluatorFactory<InputT, OutputT> implements TransformEvaluatorFactory {
  ...
  public <T> TransformEvaluator<T> forApplication(
    ...
    AppliedPTransform<PCollection<InputT>, PCollectionTuple, ParDo.BoundMulti<InputT, OutputT>>
        parDoApplication =
        (AppliedPTransform<PCollection<InputT>, PCollectionTuple, ParDo.BoundMulti<InputT,
            OutputT>>)
    ...
    TransformEvaluator<T> evaluator =
        (TransformEvaluator<T>)
            (TransformEvaluator<InputT>) createEvaluator((AppliedPTransform) application, (CommittedBundle) inputBundle, doFn,
