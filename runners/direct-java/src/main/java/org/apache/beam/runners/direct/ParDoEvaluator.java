...
class ParDoEvaluator<InputT> implements TransformEvaluator<InputT> {
  ...
  public interface RunnerFactory<InputT, OutputT> {
  ...
  public static <InputT, OutputT> RunnerFactory<InputT, OutputT> defaultRunnerFactory() {
    return new RunnerFactory<InputT, OutputT>() {
      @Override
  ...
  public static <InputT, OutputT> ParDoEvaluator<InputT> create(
      ...
      RunnerFactory<InputT, OutputT> runnerFactory) {
