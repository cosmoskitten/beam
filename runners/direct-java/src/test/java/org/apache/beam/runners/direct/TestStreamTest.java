...
public class TestStreamTest implements Serializable {
  ...
  public void testLateDataAccumulating() {
    ...
    TestStream<Integer> source = TestStream.create(new TypeDescriptor<Integer>() {
    })
  ...
  public void testProcessingTimeTrigger() {
    TestStream<Long> source = TestStream.create(TypeDescriptor.of(Long.class))
    ...
    PAssert.that(sum).inWindow(GlobalWindow.INSTANCE).containsInAnyOrder(3L, 6L);
