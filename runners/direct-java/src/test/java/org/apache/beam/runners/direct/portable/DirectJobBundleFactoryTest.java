...
public class DirectJobBundleFactoryTest {
  ...
  private DirectJobBundleFactory factory;
  ...
  public void setup() throws Exception {
    ...
    factory = new DirectJobBundleFactory(environmentFactory, dataServer, stateServer);
  }
  ...
  public void closeShutsDownEnvironmentsWhenSomeFail() throws Exception {
    ...
    try {
      ...
      if (expected.equals(firstException)) {
        ...
        assertThat(expected, equalTo(thirdException));
