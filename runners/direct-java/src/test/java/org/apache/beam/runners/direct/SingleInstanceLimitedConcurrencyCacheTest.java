...
/**
 * Tests for {@link SingleInstanceLimitedConcurrencyCache}.
 */
@RunWith(JUnit4.class)
public class SingleInstanceLimitedConcurrencyCacheTest {
  @Rule public ExpectedException thrown = ExpectedException.none();
  private SingleInstanceLimitedConcurrencyCache<String, Integer> cache =
