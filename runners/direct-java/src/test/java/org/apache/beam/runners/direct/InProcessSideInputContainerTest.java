...
public class InProcessSideInputContainerTest {
  ...
  public void isReadyForEmptyWindowTrue() {
    ...
    CountDownLatch latch = invokeLatchedCallback(singletonView, GlobalWindow.INSTANCE);
   ...
   */
  private CountDownLatch invokeLatchedCallback(PCollectionView<?> view, BoundedWindow window) {
