...
public class MetricsGraphiteSinkTest {
  ...
  public void testWriteMetricsWithCommittedSupported() throws Exception {
    ...
    String regexpr =
        "beam.counter.ns.n1.committed.value 10 [0-9]+\\n"
            + "beam.counter.ns.n1.attempted.value 20 [0-9]+\\n"
            + "beam.gauge.ns.n3.committed.value 100 [0-9]+\\n"
            + "beam.gauge.ns.n3.attempted.value 120 [0-9]+\\n"
            + "beam.distribution.ns.n2.committed.min 5 [0-9]+\\n"
            + "beam.distribution.ns.n2.attempted.min 3 [0-9]+\\n"
            + "beam.distribution.ns.n2.committed.max 8 [0-9]+\\n"
            + "beam.distribution.ns.n2.attempted.max 9 [0-9]+\\n"
            + "beam.distribution.ns.n2.committed.count 2 [0-9]+\\n"
            + "beam.distribution.ns.n2.attempted.count 4 [0-9]+\\n"
            + "beam.distribution.ns.n2.committed.sum 10 [0-9]+\\n"
            + "beam.distribution.ns.n2.attempted.sum 25 [0-9]+\\n"
            + "beam.distribution.ns.n2.committed.mean 5.0 [0-9]+\\n"
            + "beam.distribution.ns.n2.attempted.mean 6.25 [0-9]+";
