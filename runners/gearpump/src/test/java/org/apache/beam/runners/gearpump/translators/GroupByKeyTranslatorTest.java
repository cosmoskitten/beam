...
public class GroupByKeyTranslatorTest {
  ...
  private static class TestSource extends UnboundedSource<String, UnboundedSource.CheckpointMark> {
    ...
    public TestSource(List<KV<String, Instant>> data) {
      this.data = data;
    }
    ...
    public UnboundedReader<String> createReader(PipelineOptions options,
      ...
      return new TestReader(data, this);
    }
    ...
    public static class TestReader extends UnboundedReader<String> implements Serializable {
      ...
      public TestReader(List<KV<String, Instant>> data, TestSource source) {
        this.data = data;
        this.source = source;
      }
