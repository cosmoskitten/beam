...
public class UngroupedShuffleReader<T> extends NativeReader<T> {
  ...
  static class UngroupedShuffleReaderIterator<T> extends NativeReaderIterator<T> {
    ...
    UngroupedShuffleReaderIterator(
      ...
      this.iterator =
          entryReader.read(
              shuffleReader.startShufflePosition == null ? null : ByteArrayShufflePosition.fromBase64(shuffleReader.startShufflePosition),
              shuffleReader.stopShufflePosition == null ? null : ByteArrayShufflePosition.fromBase64(shuffleReader.stopShufflePosition));
