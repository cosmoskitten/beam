...
public class WindmillStateCacheTest {
  ...
  public void testStaleWorkItem() throws Exception {
    ...
    assertEquals(
        new TestState("w2"), keyCache.get(windowNamespace(0), tag));
    ...
    assertEquals(
        new TestState("w3"), keyCache.get(windowNamespace(0), tag));
  }
  ...
  public void testMultipleKeys() throws Exception {
    ...
    WindmillStateCache.ForKey keyCache2 =
        cache.forComputation("comp1").forKey(ByteString.copyFromUtf8("key2"), STATE_FAMILY, 0L, 10L);
    ...
    assertNull(keyCache2.get(StateNamespaces.global(), tag));
    keyCache2 =
        cache.forComputation("comp1").forKey(ByteString.copyFromUtf8("key2"), STATE_FAMILY, 0L, 20L);
