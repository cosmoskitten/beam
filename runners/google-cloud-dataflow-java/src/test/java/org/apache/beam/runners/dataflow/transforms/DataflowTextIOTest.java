...
/**
 * Unit tests for Dataflow usage of {@link TextIO} transforms.
 */
public class DataflowTextIOTest {
  ...
  public void testPrimitiveDisplayData() {
    ...
    Set<DisplayData> displayDatas = evaluator.displayDataForPrimitiveTransforms(write);
    assertThat(displayDatas, hasItem(hasDisplayItem(hasValue(startsWith("foobar")))));
  }
}
