...
public class DataflowCombineTest {
  ...
  private DisplayDataEvaluator evaluator;

  @Before
  public void setUp() {
    evaluator = DataflowDisplayDataEvaluator.create(tempFolder.getRoot());
  }
  ...
  public void testCombinePerKeyPrimitiveDisplayData() {
    ...
    Set<DisplayData> displayDatas = evaluator.displayDataForPrimitiveTransforms(combine,
        KvCoder.of(VarIntCoder.of(), VarIntCoder.of()));

    assertThat(displayDatas, hasItem(hasDisplayItem("combineFn", combineFn.getClass())));
  }
}
