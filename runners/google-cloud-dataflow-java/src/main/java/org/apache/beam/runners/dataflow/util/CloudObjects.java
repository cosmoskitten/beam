  ...
  public static Coder<?> coderFromCloudObject(CloudObject cloudObject) {
    ...
    if (cloudObject.getClassName().equals(CustomCoder.class.getName())) {
      return customCoderFromCloudObject(cloudObject);
        ...
        .getClassName()
        .equals(CloudObjectKinds.KIND_WINDOWED_VALUE_ONLY_WRAPPER)) {
      // This statement can't be in the switch, because the class name is resolved at runtime.
    ...
    switch (cloudObject.getClassName()) {
      ...
      case CloudObjectKinds.KIND_BYTES:
        return ByteArrayCoder.of();
      case CloudObjectKinds.KIND_VARINT:
