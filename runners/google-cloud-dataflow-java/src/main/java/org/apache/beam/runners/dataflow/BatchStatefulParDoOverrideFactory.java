  ...
  static class GbkThenStatefulParDo<K, InputT, OutputT>
    ...
    public PCollectionTuple expand(PCollection<KV<K, InputT>> input) {
      ...
      return input
          ...
          .apply("Reify windows", ParDo.of(new ReifyWindowedValueFn<K, InputT>()))
          ...
          // to alter the flow of data. For batch, we just make it all explicit:
          //  - trigger just once
          //  - no such thing as late data
          //  - output at a timestamp earlier than all the grouped elements
          //  - discarding mode is irrelevant but required
          .apply(
