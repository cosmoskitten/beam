...
/**
 * A service interface for defining one-time initialization for Dataflow workers.
 *
 * <p>Dataflow workers will use {@link ServiceLoader} to run every setup() implementation as soon as
