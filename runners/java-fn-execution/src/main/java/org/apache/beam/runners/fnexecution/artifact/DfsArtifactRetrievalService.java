...
public class DfsArtifactRetrievalService
  ...
  public static DfsArtifactRetrievalService create(ResourceId manifestResourceId) {
  ...
  public void getManifest(
    ...
    try {
      ResourceId manifestResourceId =
          FileSystems
              .matchNewResource(request.getStagingToken(), true /* is directory */)
              .resolve(MANIFEST_NAME, ResolveOptions.StandardResolveOptions.RESOLVE_FILE);
  ...
  public void getArtifact(
    ...
    try {
      ResourceId artifactResourceId =
          FileSystems.matchNewResource(request.getName(), false /* is directory */);
