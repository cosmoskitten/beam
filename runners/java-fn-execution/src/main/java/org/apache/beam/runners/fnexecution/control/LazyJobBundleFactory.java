 ...
 * each client. {@link LazyJobBundleFactory} initializes the Environment lazily when the forStage is
...
public class LazyJobBundleFactory implements JobBundleFactory {
  private static final Logger LOG = LoggerFactory.getLogger(LazyJobBundleFactory.class);
