...
/** Tests for {@link LazyJobBundleFactory}. */
@RunWith(JUnit4.class)
public class LazyJobBundleFactoryTest {
  ...
  @Test
  public void FaileCreatingMultipleEnvironmentFromMultipleTypes() throws Exception {
    ServerFactory serverFactory = ServerFactory.createDefault();
  ...
  public void closesEnvironmentOnCleanup() throws Exception {
    LazyJobBundleFactory bundleFactory =
        new LazyJobBundleFactory(
            envFactory,
            stageIdGenerator,
            controlServer,
