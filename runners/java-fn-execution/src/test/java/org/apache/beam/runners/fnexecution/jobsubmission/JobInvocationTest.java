...
public class JobInvocationTest {
  ...
  public void testStateAfterCompletionWithoutResult() throws Exception {
    ...
    // Note that some Runners (e.g. Flink) only provide a result when the pipeline execution has finished
    runner.setResult(null);

    awaitChangingJobState(jobInvocation, JobApi.JobState.Enum.RUNNING, JobApi.JobState.Enum.UNSPECIFIED);
  }
  ...
  public void testStateAfterCancellation() throws Exception {
    ...
    awaitChangingJobState(jobInvocation, JobApi.JobState.Enum.RUNNING, JobApi.JobState.Enum.CANCELLED);
  }
  ...
  private static void awaitChangingJobState(JobInvocation jobInvocation, JobApi.JobState.Enum currentState, JobApi.JobState.Enum desiredState) throws Exception {
