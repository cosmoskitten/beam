...
import org.apache.beam.runners.spark.io.SourceRDD.Bounded.BoundedSourceWrapper;
...
public class BeamSparkRunnerRegistrator implements KryoRegistrator {
  ...
  /**
   * Register classes which implement {@link Coder} or {@link Source} (Or classes with such members)
   * with {@link JavaSerializer} since such implementations may not be Kryo-serializable.
   */
  @Override
  public void registerClasses(Kryo kryo) {
    kryo.register(MicrobatchSource.class, new JavaSerializer());
    kryo.register(BoundedSourceWrapper.class, new JavaSerializer());
