...
/** A set of functions to provid API compatibility between Spark 2 and Spark 3. */
@Internal
public class SparkCompat {
   ...
   *
   * <p>This is required because {@link JavaPairRDD#flatMapValues(Function)} requires a function
   * that returns an Iterator instead of an Iterable in Spark 3. For more details see:
