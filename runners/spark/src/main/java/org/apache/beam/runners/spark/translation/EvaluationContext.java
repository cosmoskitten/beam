...
public class EvaluationContext implements EvaluationResult {
  ...
  private SparkRuntimeContext runtime;
  ...
  public <T> void setBoundedDatasetFromQueue(
  ...
  public <T> T get(PValue value) {
    throw new UnsupportedOperationException("The SparkRunner does not currently support get.");
  }
