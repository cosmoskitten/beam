...
import org.apache.beam.sdk.metrics.AccumulatedAttemptedMetricsResults;
...
public abstract class SparkPipelineResult implements PipelineResult {
  ...
  public MetricResults metrics() {
    return new AccumulatedAttemptedMetricsResults(MetricsAccumulator.getInstance().value());
  }
