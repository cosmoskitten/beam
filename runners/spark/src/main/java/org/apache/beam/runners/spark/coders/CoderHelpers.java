...
public final class CoderHelpers {
  ...
  public static <T> Iterable<T> fromByteArrays(
    ...
    return Iterables.transform(
        serialized,
        new com.google.common.base.Function<byte[], T>() {
          @Override
   ...
   */
  public static <K, V>
      PairFlatMapFunction<Iterator<Tuple2<ByteArray, Iterable<byte[]>>>, K, Iterable<V>>
          fromByteFunctionIterable(final Coder<K> keyCoder, final Coder<V> valueCoder) {
    return new PairFlatMapFunction<
        Iterator<Tuple2<ByteArray, Iterable<byte[]>>>, K, Iterable<V>>() {
      @Override
