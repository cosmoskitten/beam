...
public class CheckpointDir {
  ...
  private final String rootCheckpointDir;
  private final String sparkCheckpointDir;
  ...
  public CheckpointDir(String rootCheckpointDir) {
    ...
    this.rootCheckpointDir = rootCheckpointDir;
    Path rootCheckpointPath = new Path(rootCheckpointDir);
    this.sparkCheckpointDir = new Path(rootCheckpointPath, SPARK_CHECKPOINT_DIR).toString();
  }

  public String getRootCheckpointDir() {
