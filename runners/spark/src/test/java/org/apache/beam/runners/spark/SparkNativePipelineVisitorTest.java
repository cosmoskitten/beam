...
public class SparkNativePipelineVisitorTest {
  ...
  @Rule
  public final transient PipelineRule batchPipelineRule = PipelineRule.batch();

  @Rule
  public final transient PipelineRule streamingPipelineRule = PipelineRule.streaming();
  ...
  public void debugBoundedPipeline() {
    SparkPipelineOptions options = batchPipelineRule.getOptions();
  ...
  public void debugUnboundedPipeline() {
    SparkPipelineOptions options = streamingPipelineRule.getOptions();
    options.setDebugPipeline(true);
