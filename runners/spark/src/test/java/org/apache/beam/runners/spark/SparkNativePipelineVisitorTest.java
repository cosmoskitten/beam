...
public class SparkNativePipelineVisitorTest {
  ...
  public void debugBatchPipeline() {
    TestSparkPipelineOptions options = (TestSparkPipelineOptions) batchPipelineRule.getOptions();
    ...
    TestSparkRunner.DebugSparkPipelineResult result =
        (TestSparkRunner.DebugSparkPipelineResult) pipeline.run();
  ...
  public void debugStreamingPipeline() {
    TestSparkPipelineOptions options =
        (TestSparkPipelineOptions) streamingPipelineRule.getOptions();
    options.setDebugPipeline(true);
    ...
    pipeline
        ...
        .apply(ParDo.of(new SparkNativePipelineVisitorTest.FormatKVFn()))
        .apply(Distinct.<String>create())
        .apply(WithKeys.of(new SparkNativePipelineVisitorTest.ArbitraryKeyFunction()))
        .apply(write);
