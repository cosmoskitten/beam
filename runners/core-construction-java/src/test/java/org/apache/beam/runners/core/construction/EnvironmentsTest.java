        ...
        PTransform.newBuilder()
            .setSpec(
                FunctionSpec.newBuilder()
                    ...
                    .build())
            .build();
    Environment env = Environments.getEnvironment(builder, rehydratedComponents);
    assertThat(env, nullValue());
  }
  ...
  public void getEnvironmentParDo() throws IOException {
    ...
    PTransform builder =
        PTransform.newBuilder()
            ...
            .build();
    Environment env = Environments.getEnvironment(builder, rehydratedComponents);
    assertThat(env, equalTo(payload.getDoFn().getEnvironmentId()));
  }

  @Test
  public void getEnvironmentWindowInto() throws IOException {
    SdkComponents components = SdkComponents.create();
    ...
    PTransform builder =
        PTransform.newBuilder()
            ...
            .build();
    Environment env = Environments.getEnvironment(builder, rehydratedComponents);
    assertThat(env, equalTo(payload.getWindowFn().getEnvironmentId()));
  }
  ...
  public void getEnvironmentRead() throws IOException {
    ...
    PTransform builder =
        PTransform.newBuilder()
            ...
            .build();
    Environment env = Environments.getEnvironment(builder, rehydratedComponents);
    assertThat(env, equalTo(payload.getSource().getEnvironmentId()));
  }
  ...
  public void getEnvironmentCombine() throws IOException {
    ...
    PTransform builder =
        PTransform.newBuilder()
            ...
            .build();
    Environment env = Environments.getEnvironment(builder, rehydratedComponents);
    assertThat(env, equalTo(payload.getCombineFn().getEnvironmentId()));
  }
}
