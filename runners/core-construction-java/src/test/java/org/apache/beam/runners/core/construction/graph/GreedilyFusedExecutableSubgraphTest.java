...
/** Tests for {@link GreedilyFusedExecutableSubgraph}. */
@RunWith(JUnit4.class)
public class GreedilyFusedExecutableSubgraphTest {
  ...
  public void noInitialConsumersThrows() {
    ...
    GreedilyFusedExecutableSubgraph.forGrpcPortRead(p, readOutputNode, Collections.emptySet());
  }
  ...
  public void differentEnvironmentsThrows() {
    ...
    GreedilyFusedExecutableSubgraph.forGrpcPortRead(p, readOutputNode, differentEnvironments);
  }
  ...
  public void nonReadRootThrows() {
    ...
    GreedilyFusedExecutableSubgraph.forRootTransform(p, getOnlyElement(p.getRootTransforms()));
  }
  ...
  public void fusesCompatibleEnivronmentsReadingFromPCollection() {
    ...
    ExecutableSubgraph subgraph =
        GreedilyFusedExecutableSubgraph.forGrpcPortRead(
  ...
  public void fusesFlattenWithDifferentEnvironmentInputs() {
    ...
    // flatten once.
    ExecutableSubgraph readFromOtherEnv =
        GreedilyFusedExecutableSubgraph.forRootTransform(p, p.transformNode("envRead"));
    assertThat(
  ...
  public void materializesWithDifferentEnvSibling() {
    ...
    ExecutableSubgraph subgraph = GreedilyFusedExecutableSubgraph.forRootTransform(p, readNode);
