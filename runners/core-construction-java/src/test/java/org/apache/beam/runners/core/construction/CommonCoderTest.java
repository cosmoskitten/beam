...
import static org.apache.beam.runners.core.construction.StandardUrns.getStandardUrn;
...
import org.apache.beam.model.pipeline.v1.RunnerApi.StandardCoderUrns;
...
public class CommonCoderTest {
  ...
  private static final Map<String, Class<?>> coders =
      ImmutableMap.<String, Class<?>>builder()
          .put(getStandardUrn(StandardCoderUrns.Enum.BYTES), ByteCoder.class)
          .put(getStandardUrn(StandardCoderUrns.Enum.KV), KvCoder.class)
          .put(getStandardUrn(StandardCoderUrns.Enum.VARINT), VarLongCoder.class)
          .put(getStandardUrn(StandardCoderUrns.Enum.INTERVAL_WINDOW), IntervalWindowCoder.class)
          .put(getStandardUrn(StandardCoderUrns.Enum.ITERABLE), IterableCoder.class)
          .put(getStandardUrn(StandardCoderUrns.Enum.GLOBAL_WINDOW), GlobalWindow.Coder.class)
          .put(
              getStandardUrn(StandardCoderUrns.Enum.WINDOWED_VALUE),
  ...
  private static Object convertValue(Object value, CommonCoder coderSpec, Coder coder) {
    ...
    if (s.equals(getStandardUrn(StandardCoderUrns.Enum.BYTES))) {
      return ((String) value).getBytes(StandardCharsets.ISO_8859_1);
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.KV))) {
      ...
      return KV.of(k, v);
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.VARINT))) {
      return ((Number) value).longValue();
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.INTERVAL_WINDOW))) {
      Map<String, Object> kvMap = (Map<String, Object>) value;
    ...
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.ITERABLE))) {
    ...
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.GLOBAL_WINDOW))) {
      return GlobalWindow.INSTANCE;
    } else if (s.equals(getStandardUrn(StandardCoderUrns.Enum.WINDOWED_VALUE))) {
      Map<String, Object> kvMap = (Map<String, Object>) value;
