      ...
      return SdkFunctionSpec.newBuilder()
          .setSpec(
              FunctionSpec.newBuilder()
                  ...
                  .setAny(Any.pack(BytesValue.newBuilder().setValue(serializedFn).build()))
                  .setParameter(serializedFn)
                  .build())
          .build();
      ...
      return SdkFunctionSpec.newBuilder()
          .setSpec(
              FunctionSpec.newBuilder()
                  ...
                  .setAny(Any.pack(fixedWindowsPayload))
                  .setParameter(fixedWindowsPayload.toByteString()))
          .build();
      ...
      return SdkFunctionSpec.newBuilder()
          .setSpec(
              FunctionSpec.newBuilder()
                  ...
                  .setAny(Any.pack(slidingWindowsPayload))
                  .setParameter(slidingWindowsPayload.toByteString()))
          .build();
      ...
      return SdkFunctionSpec.newBuilder()
          .setSpec(
              FunctionSpec.newBuilder()
                  ...
                  .setAny(Any.pack(sessionsPayload))
                  .setParameter(sessionsPayload.toByteString()))
          .build();
    } else {
      return SdkFunctionSpec.newBuilder()
          .setSpec(
      ...
      switch (windowFnSpec.getSpec().getUrn()) {
        ...
        case FIXED_WINDOWS_FN:
          ...
          fixedParams =
              StandardWindowFns.FixedWindowsPayload.parseFrom(
                  windowFnSpec.getSpec().getParameter());
        ...
        case SESSION_WINDOWS_FN:
          StandardWindowFns.SessionsPayload sessionParams =
              StandardWindowFns.SessionsPayload.parseFrom(windowFnSpec.getSpec().getParameter());
