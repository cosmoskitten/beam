...
public class RehydratedComponents {
  ...
  static RehydratedComponents create(RunnerApi.Components components) {
  ...
  /**
   * Registers the provided {@link WindowingStrategy} into this {@link RehydratedComponents}, returning a
