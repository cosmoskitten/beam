...
public interface ExecutableStage {
   ...
   *   <li>The {@link PTransform#getSpec()} contains an {@link ExecutableStagePayload} which has its
   *       input and output PCollections set to the same values as the outer PTransform itself. It
