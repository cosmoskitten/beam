...
abstract class ImmutableExecutableStage implements ExecutableStage {
  static ImmutableExecutableStage ofFullComponents(
      ...
      Collection<KeyedStateReference> keyedStates,
    ...
    Components prunedComponents =
        components
            ...
            .build();
    return of(prunedComponents, environment, input, sideInputs, keyedStates, transforms, outputs);
  }
  ...
  static ImmutableExecutableStage of(
    ...
    return new AutoValue_ImmutableExecutableStage(
        ...
        ImmutableSet.copyOf(keyedStates),
  ...
  @Override
  public abstract Collection<KeyedStateReference> getKeyedStates();
