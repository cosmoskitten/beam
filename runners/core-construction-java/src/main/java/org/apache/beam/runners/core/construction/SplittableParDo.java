...
public class SplittableParDo<InputT, OutputT, RestrictionT>
   ...
   */
  public static class SplittableProcessKeyed<InputT, OutputT, RestrictionT>
      extends PTransform<
    ...
    public PCollectionTuple expand(
        PCollection<KV<String, ElementAndRestriction<InputT, RestrictionT>>>
            input) {
      return createPrimitiveOutputFor(input);
    }

    public PCollectionTuple createPrimitiveOutputFor(PCollection<?> input) {
