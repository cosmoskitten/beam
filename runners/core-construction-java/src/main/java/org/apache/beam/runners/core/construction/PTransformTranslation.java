...
public class PTransformTranslation {
  ...
  public static final String PAR_DO_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.PAR_DO);
  public static final String FLATTEN_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.FLATTEN);
  public static final String GROUP_BY_KEY_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.GROUP_BY_KEY);
  public static final String IMPULSE_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.IMPULSE);
  public static final String READ_TRANSFORM_URN = getStandardUrn(StandardPTransformUrns.Enum.READ);
  public static final String ASSIGN_WINDOWS_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.ASSIGN_WINDOWS);
  public static final String TEST_STREAM_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.TEST_STREAM);

  // Not strictly a primitive transform
  public static final String COMBINE_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.COMBINE_PER_KEY);

  public static final String RESHUFFLE_URN = getStandardUrn(StandardPTransformUrns.Enum.RESHUFFLE);

  // Less well-known. And where shall these live?
  public static final String WRITE_FILES_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.WRITE_FILES);
  ...
  public static final String CREATE_VIEW_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.Enum.CREATE_VIEW);
