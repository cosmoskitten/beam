...
import org.apache.beam.model.pipeline.v1.RunnerApi.StandardPTransformUrns;
...
public class PTransformTranslation {
  ...
  public static final String PAR_DO_TRANSFORM_URN = getStandardUrn(StandardPTransformUrns.PAR_DO);
  public static final String FLATTEN_TRANSFORM_URN = getStandardUrn(StandardPTransformUrns.FLATTEN);
  public static final String GROUP_BY_KEY_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.GROUP_BY_KEY);
  public static final String IMPULSE_TRANSFORM_URN = getStandardUrn(StandardPTransformUrns.IMPULSE);
  public static final String READ_TRANSFORM_URN = getStandardUrn(StandardPTransformUrns.READ);
  public static final String ASSIGN_WINDOWS_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.ASSIGN_WINDOWS);
  public static final String TEST_STREAM_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.TEST_STREAM);

  // Not strictly a primitive transform
  public static final String COMBINE_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.COMBINE_PER_KEY);

  public static final String RESHUFFLE_URN = getStandardUrn(StandardPTransformUrns.RESHUFFLE);

  // Less well-known. And where shall these live?
  public static final String WRITE_FILES_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.WRITE_FILES);
  ...
  public static final String CREATE_VIEW_TRANSFORM_URN =
      getStandardUrn(StandardPTransformUrns.CREATE_VIEW);
