 ...
 * See {@link RepeatedlyReactor#forever} and {@link AfterWatermarkReactor#pastEndOfWindow} for more details.
 */
...
public class DefaultTriggerReactor extends TriggerReactor{
  ...
  @Override
  public TriggerReactor getContinuationTrigger(List<TriggerReactor> continuationTriggers) {
    return this;
  }
