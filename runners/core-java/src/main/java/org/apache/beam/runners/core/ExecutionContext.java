...
import org.apache.beam.sdk.transforms.DoFn.ElementContext;
...
public interface ExecutionContext {
   ...
   * {@link ElementContext#output(TupleTag, Object)} is called.
   */
  ...
  public interface StepContext {
    ...
    /**
     * Hook for subclasses to implement that will be called whenever
     * {@link org.apache.beam.sdk.transforms.DoFn.ElementContext#output}
     * is called.
     */
    void noteOutput(WindowedValue<?> output);
