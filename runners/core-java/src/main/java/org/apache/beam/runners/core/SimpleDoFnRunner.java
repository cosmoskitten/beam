...
public class SimpleDoFnRunner<InputT, OutputT> implements DoFnRunner<InputT, OutputT> {
  ...
  private DoFnProcessContext<InputT, OutputT> createProcessContext
  ...
  private static class DoFnContext<InputT, OutputT> extends DoFn<InputT, OutputT>.Context
    ...
    public BoundedWindow window() {
      throw new UnsupportedOperationException("Cannot access window.");
    }
    ...
    public ProcessContext processContext(DoFn<InputT, OutputT> doFn) {
      throw new UnsupportedOperationException("Cannot access ProcessContext.");
    }
    ...
    public WindowingInternals<InputT, OutputT> windowingInternals() {
      throw new UnsupportedOperationException("WindowingInternals are unsupported here.");
    }

    @Override
    public <RestrictionT> RestrictionTracker<RestrictionT> restrictionTracker() {
      throw new UnsupportedOperationException("RestrictionTracker is unsupported here.");
    }

    @Override
    public State state(String stateId) {
      throw new UnsupportedOperationException("State is unsupported here.");
    }

    @Override
    public Timer timer(String timerId) {
      throw new UnsupportedOperationException("Timers are unsupported here.");
    }
  }
