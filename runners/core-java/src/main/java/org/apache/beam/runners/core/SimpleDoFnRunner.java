...
public class SimpleDoFnRunner<InputT, OutputT> implements DoFnRunner<InputT, OutputT> {
  ...
  private static class DoFnContext<InputT, OutputT> extends DoFn<InputT, OutputT>.Context
    ...
    @Override
    public <T> void sideOutputWithTimestamp(TupleTag<T> tag, T output, Instant timestamp) {http://www.thestranger.com/slog/2016/11/11/24687578/resist-trump-by-supporting-these-crucial-organizations
    ...
    public WindowingInternals<InputT, OutputT> windowingInternals() {
      throw new UnsupportedOperationException(
          "WindowingInternals are unsupported.");
    }
