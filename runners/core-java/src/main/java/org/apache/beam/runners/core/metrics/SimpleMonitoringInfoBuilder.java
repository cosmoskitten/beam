...
public class SimpleMonitoringInfoBuilder {
  ...
  public SimpleMonitoringInfoBuilder() {
    ...
    for (MonitoringInfoTypeUrns.Enum val : MonitoringInfoSpecs.Enum.values()) {
      ;
    }
    /*
    for () {
      ProtocolMessageEnum value = ;
      MonitoringInfoSpec monitoring_info_spec = value.getValueDescriptor().getOptions()
