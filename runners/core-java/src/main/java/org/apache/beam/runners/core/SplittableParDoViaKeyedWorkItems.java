...
import org.apache.beam.runners.core.construction.SplittableParDo.SplittableProcessKeyed;
...
/** Utilities for implementing {@link SplittableProcessKeyed} via {@link KeyedWorkItem}. */
public class SplittableParDoViaKeyedWorkItems {
  ...
  /** Overrides a {@link SplittableProcessKeyed} into {@link SplittableProcessViaKeyedWorkItems}. */
  public static class OverrideFactory<InputT, OutputT, RestrictionT>
      implements PTransformOverrideFactory<
          ...
          SplittableProcessKeyed<InputT, OutputT, RestrictionT>> {
    @Override
    public PTransformReplacement<
        ...
        getReplacementTransform(
            AppliedPTransform<
                    ...
                    PCollectionTuple, SplittableProcessKeyed<InputT, OutputT, RestrictionT>>
                transform) {
  ...
  public static class SplittableProcessViaKeyedWorkItems<InputT, OutputT, RestrictionT>
      extends PTransform<
          PCollection<KV<String, ElementAndRestriction<InputT, RestrictionT>>>, PCollectionTuple> {
    private final SplittableProcessKeyed<InputT, OutputT, RestrictionT> original;

    public SplittableProcessViaKeyedWorkItems(
        SplittableProcessKeyed<InputT, OutputT, RestrictionT> original) {
  ...
  public static class ProcessElements<
    ...
    public ProcessElements(SplittableProcessKeyed<InputT, OutputT, RestrictionT> original) {
      this.original = original;
    }
    ...
    public PCollectionTuple expand(
      ...
      return original.createPrimitiveOutputFor(input);
    }
  }
