...
import static org.apache.beam.model.fnexecution.v1.BeamFnApi.Metric.DataCase.EXTREMA_DATA;
        ...
        switch (counterData.getValueCase()) {
          case INT64_VALUE:
            ...
            if (type.equals(SUM_INT64_TYPE_URN)) {
              ...
              gaugeFn.accept(GaugeProtos.fromProto(value));
            } else {
      ...
      case DISTRIBUTION_DATA:
        ...
        switch (distributionData.getDistributionCase()) {
          case INT_DISTRIBUTION_DATA:
            distributionFn.accept(
                DistributionProtos.fromProto(distributionData.getIntDistributionData()));
            break;
