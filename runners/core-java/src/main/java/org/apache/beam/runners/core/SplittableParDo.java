...
public class SplittableParDo {
  ...
  public static class ForSingleOutput<InputT, OutputT, RestrictionT>
    ...
    /**
     * Creates the transform for the given original {@link ParDo}.
     *
    ...
    public ForSingleOutput(ParDo.Bound<InputT, OutputT> parDo) {
      ...
      checkArgument(
          DoFnSignatures.INSTANCE
              .signatureForDoFn(parDo.getNewFn())
              .processElement()
              .isSplittable(),
    ...
    private PCollection<OutputT> applyTyped(PCollection<InputT> input) {
      DoFn<InputT, OutputT> fn = parDo.getNewFn();
      TupleTag<OutputT> mainOutputTag = new TupleTag<OutputT>() {};
  ...
  public static class ProcessElements<InputT, OutputT, RestrictionT>
    ...
    public PCollectionTuple apply(
        PCollection<? extends KeyedWorkItem<String, ElementAndRestriction<InputT, RestrictionT>>>
            input) {
      DoFnSignature signature = DoFnSignatures.INSTANCE.signatureForDoFn(fn);
