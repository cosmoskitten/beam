...
<<<<<<< 241566d0e47d972b5afa7a0ab43b856dddb60ed6:runners/core-java/src/test/java/org/apache/beam/runners/core/reactors/AfterEachTest.java
import org.apache.beam.sdk.util.TriggerTester;
import org.apache.beam.sdk.util.TriggerTester.SimpleTriggerTester;
=======

>>>>>>> Rename trigger reactors:runners/core-java/src/test/java/org/apache/beam/runners/core/reactors/AfterEachReactorTest.java
...
public class AfterEachReactorTest {
  ...
  public void testFireDeadline() throws Exception {
    ...
    assertEquals(new Instant(9),
        AfterEachReactor.inOrder(AfterWatermarkReactor.pastEndOfWindow(),
                          AfterPaneReactor.elementCountAtLeast(4))
            .getWatermarkThatGuaranteesFiring(window));

    assertEquals(
        BoundedWindow.TIMESTAMP_MAX_VALUE,
        AfterEachReactor.inOrder(
                AfterPaneReactor.elementCountAtLeast(2), AfterWatermarkReactor.pastEndOfWindow())
            .getWatermarkThatGuaranteesFiring(window));
  }

  @Test
  public void testContinuation() throws Exception {
    OnceTrigger trigger1 = AfterProcessingTimeReactor.pastFirstElementInPane();
    OnceTrigger trigger2 = AfterWatermarkReactor.pastEndOfWindow();
    TriggerReactor afterEach = AfterEachReactor.inOrder(trigger1, trigger2);
    assertEquals(
        RepeatedlyReactor.forever(AfterFirstReactor.of(
