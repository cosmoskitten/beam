...
public class RepeatedlyReactorTest {
  ...
  public void testFireDeadline() throws Exception {
    ...
    assertThat(
        RepeatedlyReactor.forever(mockTrigger).getWatermarkThatGuaranteesFiring(window),
  ...
  public void testContinuation() throws Exception {
    ...
    TriggerReactor repeatedly = RepeatedlyReactor.forever(trigger);
    assertEquals(
        RepeatedlyReactor.forever(trigger.getContinuationTrigger()), repeatedly.getContinuationTrigger());
    assertEquals(
        RepeatedlyReactor.forever(trigger.getContinuationTrigger().getContinuationTrigger()),
