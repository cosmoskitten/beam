...
public class DefaultTriggerReactorTest {
  ...
  public void testFireDeadline() throws Exception {
    assertEquals(new Instant(9), DefaultTriggerReactor.of().getWatermarkThatGuaranteesFiring(
        new IntervalWindow(new Instant(0), new Instant(10))));
    assertEquals(GlobalWindow.INSTANCE.maxTimestamp(),
        DefaultTriggerReactor.of().getWatermarkThatGuaranteesFiring(GlobalWindow.INSTANCE));
  }

  @Test
  public void testContinuation() throws Exception {
    assertEquals(DefaultTriggerReactor.of(), DefaultTriggerReactor.of().getContinuationTrigger());
  }
}
