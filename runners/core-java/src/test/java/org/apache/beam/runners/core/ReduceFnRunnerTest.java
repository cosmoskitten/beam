...
public class ReduceFnRunnerTest {
  ...
  @Test
  public void testMergingWatermarkHoldLateNewWindowExtendedPastInputWatermarkAndFurther() throws Exception {
    LinkedList<Action> actions = new LinkedList<>();
    actions.add(Action.inputWatermark(40));
    actions.add(Action.times(25));
    actions.add(Action.times(33));
  ...
  @Test
  public void testMergingWatermarkHoldLateNewWindowMergedWithOntimeSingleProcessing() throws Exception {
    LinkedList<Action> actions = new LinkedList<>();
    actions.add(Action.inputWatermark(40));
