...
public class AfterAllReactorTest {
  ...
  public void testFireDeadline() throws Exception {
    ...
    assertEquals(BoundedWindow.TIMESTAMP_MAX_VALUE,
        AfterAllReactor.of(AfterWatermarkReactor.pastEndOfWindow(), AfterPaneReactor.elementCountAtLeast(1))
  ...
  public void testContinuation() throws Exception {
    ...
    TriggerReactor afterAll = AfterAllReactor.of(trigger1, trigger2);
    assertEquals(
        AfterAllReactor.of(trigger1.getContinuationTrigger(), trigger2.getContinuationTrigger()),
        afterAll.getContinuationTrigger());
  }

  @Test
  public void testToString() {
    TriggerReactor trigger = AfterAllReactor.of(StubTriggerReactor.named("t1"), StubTriggerReactor.named("t2"));
