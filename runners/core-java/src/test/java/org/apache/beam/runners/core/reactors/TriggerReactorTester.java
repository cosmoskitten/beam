...
public class TriggerReactorTester<InputT, W extends BoundedWindow> {
  ...
  public static class SimpleTriggerReactorTester<W extends BoundedWindow>
    ...
    private SimpleTriggerReactorTester(WindowingStrategy<Object, W> windowingStrategy)
        throws Exception {
...
<<<<<<< 241566d0e47d972b5afa7a0ab43b856dddb60ed6:runners/core-java/src/test/java/org/apache/beam/runners/core/reactors/TriggerTester.java
...
>>>>>>> Rename trigger reactors:runners/core-java/src/test/java/org/apache/beam/runners/core/reactors/TriggerReactorTester.java
   ...
   */
  private final ExecutableTriggerReactor executableTrigger;
  ...
  public static <W extends BoundedWindow> SimpleTriggerReactorTester<W> forTrigger(
    ...
    return new SimpleTriggerReactorTester<>(windowingStrategy);
  }
  ...
  public static <InputT, W extends BoundedWindow>
    ...
    return new TriggerReactorTester<>(strategy);
  }

  protected TriggerReactorTester(WindowingStrategy<Object, W> windowingStrategy) throws Exception {
