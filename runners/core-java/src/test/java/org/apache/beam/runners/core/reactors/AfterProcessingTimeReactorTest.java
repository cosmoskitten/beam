...
/**
 * Tests the {@link AfterProcessingTimeReactor}.
 */
@RunWith(JUnit4.class)
public class AfterProcessingTimeReactorTest {
  ...
  public void testFireDeadline() throws Exception {
    assertEquals(BoundedWindow.TIMESTAMP_MAX_VALUE,
        AfterProcessingTimeReactor.pastFirstElementInPane().getWatermarkThatGuaranteesFiring(
  ...
  public void testContinuation() throws Exception {
    OnceTrigger firstElementPlus1 =
        AfterProcessingTimeReactor.pastFirstElementInPane().plusDelayOf(Duration.standardHours(1));
    assertEquals(
        new AfterSynchronizedProcessingTimeReactor(),
  ...
  public void testCompatibilityIdentical() throws Exception {
    TriggerReactor t1 = AfterProcessingTimeReactor.pastFirstElementInPane()
            .plusDelayOf(Duration.standardMinutes(1L));
    TriggerReactor t2 = AfterProcessingTimeReactor.pastFirstElementInPane()
            .plusDelayOf(Duration.standardMinutes(1L));
  ...
  public void testToString() {
    TriggerReactor trigger = AfterProcessingTimeReactor.pastFirstElementInPane();
  ...
  public void testBuiltUpToString() {
    TriggerReactor trigger = AfterWatermarkReactor.pastEndOfWindow()
        .withLateFirings(AfterProcessingTimeReactor
            .pastFirstElementInPane()
