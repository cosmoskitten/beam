...
public class SideInputHandlerTest {
  ...
  public void testElementHandling() {
    ...
    // both view should be contained
    assertTrue(sideInputHandler.contains(view1));
    assertTrue(sideInputHandler.contains(view2));
    ...
    sideInputHandler.addSideInputValue(
        view1,
        valuesInWindow(ImmutableList.of("Ciao", "Buongiorno"), new Instant(0), firstWindow));

    assertTrue(sideInputHandler.isReady(view1, firstWindow));
    Assert.assertThat(sideInputHandler.get(view1, firstWindow), contains("Ciao", "Buongiorno"));

    // view2 should not have any data
    assertFalse(sideInputHandler.isReady(view2, firstWindow));
    assertFalse(sideInputHandler.isReady(view2, secondWindow));
    ...
    assertTrue(sideInputHandler.isReady(view1, secondWindow));
