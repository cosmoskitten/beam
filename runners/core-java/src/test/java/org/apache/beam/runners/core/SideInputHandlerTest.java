...
public class SideInputHandlerTest {
  ...
  public void testIsReady() {
    ...
    sideInputHandler.addSideInputValue(
        view1,
        valuesInWindow(ImmutableList.of(KV.<Void, String>of(null, "Hello")),
  ...
  public void testNewInputReplacesPreviousInput() {
    ...
    sideInputHandler.addSideInputValue(
        ...
        valuesInWindow(
            ImmutableList.of(
                KV.<Void, String>of(null, "Ciao"),
                KV.<Void, String>of(null, "Buongiorno")),
            new Instant(0), window));
  ...
  public void testMultipleWindows() {
    ...
    sideInputHandler.addSideInputValue(
        view1,
        valuesInWindow(ImmutableList.of(KV.<Void, String>of(null, "Arrivederci")),
  ...
  public void testMultipleSideInputs() {
    ...
    sideInputHandler.addSideInputValue(
        view2,
        valuesInWindow(ImmutableList.of(KV.<Void, String>of(null, "Salut")),
            new Instant(0), firstWindow));
  ...
  private WindowedValue<Iterable<?>> valuesInWindow(
      ImmutableList<KV<Void, String>> values, Instant timestamp, BoundedWindow window) {
