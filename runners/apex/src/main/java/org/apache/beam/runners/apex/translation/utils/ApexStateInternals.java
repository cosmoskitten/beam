...
public class ApexStateInternals<K> implements StateInternals<K> {
   ...
   */
  @DefaultSerializer(JavaSerializer.class)
  public static class StateInternalsProxy<K> implements StateInternals<K>, Serializable {

    private final ApexStateInternalsFactory<K> factory;
    private transient K currentKey;

    public StateInternalsProxy(ApexStateInternalsFactory<K> factory) {
      this.factory = factory;
    }

    public ApexStateInternalsFactory<K> getFactory() {
      return this.factory;
    }
