...
public class ApexProcessFnOperator<InputT> extends BaseOperator {
  ...
  private final ProcessFn<InputT> fn;

  public ApexProcessFnOperator(ProcessFn<InputT> fn, boolean traceTuples) {
    super();
   ...
   * @param <InputT>
   */
  public static class ProcessFn<InputT> implements Serializable {
    public void process(ApexStreamTuple<WindowedValue<InputT>> input,
   ...
   * @param <V>
   */
  public static class ToKeyedWorkItems<K, V> extends ProcessFn<KV<K, V>> {
    @Override
  ...
  public static <T, W extends BoundedWindow> ApexProcessFnOperator<T> assignWindows(
    ...
    ProcessFn<T> fn = new AssignWindows<T, W>(windowFn);
   ...
   * @param <W>
   */
  private static class AssignWindows<T, W extends BoundedWindow> extends ProcessFn<T> {
