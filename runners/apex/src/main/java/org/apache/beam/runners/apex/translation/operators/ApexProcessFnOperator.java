...
public class ApexProcessFnOperator<InputT> extends BaseOperator {
   ...
   * @param <InputT>
   */
  public interface ProcessFn<InputT> extends Serializable {
   ...
   * @param <V>
   */
  public static class ToKeyedWorkItems<K, V> implements ProcessFn<KV<K, V>> {
    @Override
   ...
   * @param <W>
   */
  private static class AssignWindows<T, W extends BoundedWindow> implements ProcessFn<T> {
