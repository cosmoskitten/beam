 ...
 * {@link org.apache.beam.sdk.transforms.View.AsIterable} PTransforms.
 */
public final class FlinkStreamingViewAsIterableOverrideFactory<T>
  ...
  public PTransform<PCollection<T>, PCollectionView<Iterable<T>>> getReplacementTransform(
      View.AsIterable<T> transform) {
    return new FlinkStreamingViewAsIterable<>();
  }
  ...
  public Map<PValue, ReplacementOutput> mapOutputs(
      List<TaggedPValue> outputs, PCollectionView<Iterable<T>> newOutput) {
