...
public class FlinkStreamingPipelineTranslator extends FlinkPipelineTranslator {
  ...
  public CompositeBehavior enterCompositeTransform(TransformHierarchy.Node node) {
    LOG.info(genSpaces(this.depth) + "enterCompositeTransform- " + node.getFullName());
    this.depth++;
    ...
    if (transform != null) {
      ...
      if (translator != null && applyCanTranslate(transform, node, translator)) {
        ...
        LOG.info(genSpaces(this.depth) + "translated-" + node.getFullName());
  ...
  public void leaveCompositeTransform(TransformHierarchy.Node node) {
    this.depth--;
    LOG.info(genSpaces(this.depth) + "leaveCompositeTransform- " + node.getFullName());
  }

  @Override
  public void visitPrimitiveTransform(TransformHierarchy.Node node) {
    LOG.info(genSpaces(this.depth) + "visitPrimitiveTransform- " + node.getFullName());
