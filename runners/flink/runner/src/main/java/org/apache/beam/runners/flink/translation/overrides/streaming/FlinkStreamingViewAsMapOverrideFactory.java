 ...
 * {@link View.AsMap} PTransforms.
 */
public final class FlinkStreamingViewAsMapOverrideFactory<K, V>
  ...
  public PTransform<PCollection<KV<K, V>>, PCollectionView<Map<K, V>>> getReplacementTransform(
      View.AsMap<K, V> transform) {
    return new FlinkStreamingViewAsMap<>();
  }
  ...
  public Map<PValue, ReplacementOutput> mapOutputs(
      List<TaggedPValue> outputs, PCollectionView<Map<K, V>> newOutput) {
