...
public class FlinkTransformOverridesTest {
    ...
    public void testCustomParallelism() {
        ...
        testStreamingWriteOverride(options, 10);
    }
    ...
    private void testStreamingWriteOverride(PipelineOptions options, int expectedNumShards) {
        ...
        WriteFiles<Object, Void, Object> original =
                WriteFiles.to(new TestSink(tmpFolder.toString()));
        PCollection<Object> objs = (PCollection) p.apply(Create.empty(VoidCoder.of()));
        AppliedPTransform<PCollection<Object>,
                WriteFilesResult<Void>,
                WriteFiles<Object, Void, Object>> originalApplication =
                AppliedPTransform.of("writefiles",
                        objs.expand(),
    ...
    private static class TestSink extends FileBasedSink<Object, Void, Object> {
        ...
        TestSink(String tmpFolder) {
            super(ValueProvider.StaticValueProvider.of(FileSystems.matchNewResource(tmpFolder,
                    true)),
