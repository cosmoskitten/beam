...
public class FlinkJobSubmissionTest implements Serializable {
   ...
   */
  @Test(timeout = 30_000)
  public void testLocalJobSubmission() throws Exception {
    ...
    PipelineResult.State state = job.waitUntilFinish(Duration.standardSeconds(10));
   ...
   */
  @Test(timeout = 30_000)
  public void testRemoteJobSubmission() throws Exception {
