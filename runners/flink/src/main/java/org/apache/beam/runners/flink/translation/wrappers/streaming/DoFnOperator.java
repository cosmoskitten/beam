...
public class DoFnOperator<InputT, OutputT>
  ...
  public void initializeState(StateInitializationContext context) throws Exception {
    ...
    if (keySelector != null) {
      ...
      pushedBackElementsHandler = KeyedPushedBackElementsHandler.usingState(
          keySelector,
      ...
      pushedBackElementsHandler = NonKeyedPushedBackElementsHandler.usingState(listState);
    }
    ...
    if (!sideInputs.isEmpty()) {
      ...
      while (it.hasNext()) {
        WindowedValue<InputT> value = it.next();
