  ...
  private static class FlinkKeyGroupBagState<K, T> implements BagState<T> {
    ...
    public Iterable<T> read() {
      return () -> {
        ...
        final AllKeyStateFunction allKeyStateFunction = new AllKeyStateFunction();
        try {
        ...
        return new Iterator<T>() {
          ...
          public boolean hasNext() {
            return allKeyStateFunction.stateDeque.size() > 0;
          }

          @Override
          public T next() {
            return (T) allKeyStateFunction.stateDeque.pop();
          }
        };
      };
    }
    ...
    @Override
    public void clear() {
      throw new UnsupportedOperationException("Clear is not implemented and should not be used.");
    }
  }
