...
public class FlinkSplittableDoFnFunction<K, V, OutputT>
  ...
  public void reduce(
    ...
    ((SplittableParDoViaKeyedWorkItems.ProcessFn) dofn).setStateInternalsFactory(stateInternalsFactory);
    ((SplittableParDoViaKeyedWorkItems.ProcessFn) dofn).setTimerInternalsFactory(timerInternalsFactory);
