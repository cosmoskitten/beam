...
public class FlinkJobInvoker implements JobInvoker {
  ...
  public static FlinkJobInvoker create(
    ...
    return new FlinkJobInvoker(executorService, artifactSource);
  }

  private final ListeningExecutorService executorService;
  private final ArtifactSource artifactSource;

  private FlinkJobInvoker(ListeningExecutorService executorService, ArtifactSource artifactSource) {
