...
def compare_dependency_release_dates(curr_release_date, latest_release_date):
  ...
  if curr_release_date is None or latest_release_date is None:
    ...
    curr_date = datetime.strptime(curr_release_date, _DATE_FORMAT)
    latest_date = datetime.strptime(latest_release_date, _DATE_FORMAT)
    if (latest_date - curr_date).days >= _MAX_STALE_DAYS:
      return True
  return False
