...
if [[ $confirmation = "y" ]]; then
  ...
  docker rmi -f docker push apachebeam/java_sdk:${RELEASE}
  docker rmi -f docker push apachebeam/java_sdk:latest

  docker rmi -f push apachebeam/go_sdk:${RELEASE}
  docker rmi -f push apachebeam/go_sdk:latest
fi
