...
class MobileGamingJavaUtils {
    ...
    // Lists used to verify random team names.
    ...
    private String generateUserScoreCommand(String runner, TestScripts t){
    ...
    private String generateHourlyTeamScoreCommand(String runner, TestScripts t){
        StringBuilder cmd = new StringBuilder()
        StringBuilder exeArgs = new StringBuilder()
    ...
    private String generateLeaderBoardCommand(String runner, TestScripts t){
        StringBuilder cmd = new StringBuilder()
        StringBuilder exeArgs = new StringBuilder()
        ...
        exeArgs.append("--project=${t.gcpProject()} ")
                ...
                .append("--leaderBoardTableName=leaderboard_${RUNNERS[runner]}")
    ...
    private String generateGameStatsCommand(String runner, TestScripts t){
        StringBuilder cmd = new StringBuilder()
        StringBuilder exeArgs = new StringBuilder()
        ...
        exeArgs.append("--project=${t.gcpProject()} ")
                ...
                .append("--sessionGap=1 ")
                .append("--gameStatsTablePrefix=gamestats_${RUNNERS[runner]}")
    ...
    private String generateInjectorCommand(TestScripts t){
