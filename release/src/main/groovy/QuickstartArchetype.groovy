...
class QuickstartArchetype {
  def static generate(TestScripts t) {
    ...
    output_text = t.run """mvn archetype:generate \
    ...
    wordcounts = t.run "ls src/main/java/org/apache/beam/examples/"
    t.see "WordCount.java", wordcounts
    games = t.run "ls src/main/java/org/apache/beam/examples/complete/game/"
