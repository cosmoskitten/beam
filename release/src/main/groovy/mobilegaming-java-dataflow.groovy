...
t.run("bq rm -f -t ${t.bqDataset()}.leaderboard_dataflow-runner_user")
t.run("bq rm -f -t ${t.bqDataset()}.leaderboard_dataflow-runner_team")
...
t.see "leaderboard_dataflow-runner_user"
t.see "leaderboard_dataflow-runner_team"
t.run """bq query --batch "SELECT user FROM [${t.gcpProject()}:${t.bqDataset()}.leaderboard_dataflow-runner_user] LIMIT 10\""""
...
t.run("bq rm -f -t ${t.bqDataset()}.gamestats_dataflow-runner_sessions")
t.run("bq rm -f -t ${t.bqDataset()}.gamestats_dataflow-runner_team")
...
t.run "bq query SELECT table_id FROM ${t.bqDataset()}.__TABLES_SUMMARY__"
t.see "gamestats_dataflow-runner_sessions"
t.see "gamestats_dataflow-runner_team"
t.run """bq query --batch "SELECT team FROM [${t.gcpProject()}:${t.bqDataset()}.gamestats_dataflow-runner_team] LIMIT 10\""""
t.seeOneOf(MobileGamingJavaUtils.COLORS)
