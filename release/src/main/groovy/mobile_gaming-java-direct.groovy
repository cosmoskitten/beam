...
cmd.append("mvn compile exec:java -q ")
        ...
        .append("--tempLocation=gs://${t.gcsBucket()}/${t.gcsBucketSubDirectory()}/tmp ")
        .append("--dataset=${t.bqDataset()} ")
        .append("--topic=projects/${t.gcpProject()}/topics/${t.pubsubTopic()} ")
        .append("--output=gs://${t.gcsBucket()}/${t.gcsBucketSubDirectory()}/java-leaderboard-result.txt\" ")
        .append("-Pdirect-runner")
...
t.seeOneOf(MobileGamingTeamList.COLOR)
