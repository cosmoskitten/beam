...
result = t.run "grep user19_BananaWallaby ${MobileGamingJavaUtils.getUserScoreOutputName(runner)}* "
...
result = t.run "grep AzureBilby ${MobileGamingJavaUtils.getHourlyTeamScoreOutputName(runner)}* "
