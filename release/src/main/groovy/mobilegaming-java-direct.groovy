...
t.run("bq rm -f -t ${t.bqDataset()}.leaderboard_direct-runner_user")
t.run("bq rm -f -t ${t.bqDataset()}.leaderboard_direct-runner_team")
...
t.see "leaderboard_direct-runner_user"
t.see "leaderboard_direct-runner_team"
t.run """bq query --batch "SELECT user FROM [${t.gcpProject()}:${t.bqDataset()}.leaderboard_direct-runner_user] LIMIT 10\""""
