...
########################################################################################################
    wget https://storage.googleapis.com/python_wheels/apache_beam-2.5.0-cp27-cp27mu-manylinux1_x86_64.whl
    BEAM_PYTHON_SDK=apache_beam-2.5.0-cp27-cp27mu-manylinux1_x86_64.whl
########################################################################################################
  install_sdk
