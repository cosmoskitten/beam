...
class CodersTest(unittest.TestCase):
  TEST_CASES = [
      Person("Jon Snow", 23, None),
      Person("Daenerys Targaryen", 25, "Westeros"),
        ...
        fields=[
            schema_pb2.Field(
                ...
                type=schema_pb2.FieldType(
                    atomic_type=schema_pb2.AtomicType.STRING, nullable=False)),
            schema_pb2.Field(
                name="age",
                type=schema_pb2.FieldType(
                    atomic_type=schema_pb2.AtomicType.INT32, nullable=False)),
            schema_pb2.Field(
                name="addresss",
                type=schema_pb2.FieldType(
