  ...
  def read_records(self, file_name, range_tracker):
    ...
    with self.open_file(file_name) as file_to_read:
      ...
      while range_tracker.try_claim(next_record_start_position):
        ...
        # For compressed text files that use UnsplittableRangeTracker, above
        # try_claim would pass for an empty record at the end of file that is
        # not followed by a new line character. Since this record is at the
        # last position of the file, it should not be a part of the current
        # range. We do this check to ignore such records.
