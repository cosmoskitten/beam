...
class BigQueryQueryToTableIT(unittest.TestCase):
  ...
  def _setup_new_types_env(self):
    ...
    table_data = [
      {'bytes':str.encode('xyw='), 'date':'2011-01-01', 'time':'23:59:59.999999'},
      {'bytes':str.encode('abc='), 'date':'2000-01-01', 'time':'00:00:00'},
      {'bytes':str.encode('dec='), 'date':'3000-12-31', 'time':'23:59:59.990000'}
    ]
