...
NEW_TYPES_OUTPUT_EXPECTED = [
    ('xyw=', datetime.date(2011, 1, 1), datetime.time(23, 59, 59, 999999),),
    ('abc=', datetime.date(2000, 1, 1), datetime.time(0, 0),),
    ('dec=', datetime.date(3000, 12, 31),
     datetime.time(23, 59, 59, 999999),),
    ('\xab\xac\xad', datetime.date(2000, 1, 1), datetime.time(0, 0),)]
LEGACY_QUERY = (
...
class BigQueryQueryToTableIT(unittest.TestCase):
  ...
  def _setup_new_types_env(self):
    ...
    table_data = [
        {'bytes':'xyw=', 'date':'2011-01-01', 'time':'23:59:59.999999'},
        {'bytes':'abc=', 'date':'2000-01-01', 'time':'00:00:00'},
        {'bytes':'dec=', 'date':'3000-12-31', 'time':'23:59:59.990000'},
        {'bytes':'\xab\xac\xad', 'date':'2000-01-01', 'time':'00:00:00'}
    ]
