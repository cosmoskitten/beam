...
from bigtable_io_write_pipeline import WriteBigtableOptions
from apache_beam.testing.test_pipeline import TestPipeline
from apache_beam.options.pipeline_options import PipelineOptions
from bigtable_io_write import BigtableWriteConfiguration, WriteToBigtable
...
class BigtableIOWriteIT(unittest.TestCase):
	...
	TABLE_NAME = DEFAULT_TABLE_PREFIX
	number = 500
	...
	def test_bigtable_read_python(self):
		...
		config = BigtableWriteConfiguration(self.project, self.INSTANCE_NAME, self.TABLE_NAME)
