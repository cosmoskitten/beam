...
- May Swenson"""
  ...
  def _create_compressed_file(self, compression_type, content):
    ...
    elif compression_type == CompressionTypes.BZIP2 or compression_type == CompressionTypes.GZIP:
      compress_open = bz2.BZ2File if compression_type == CompressionTypes.BZIP2 else gzip.open
