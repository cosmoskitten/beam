...
@unittest.skipIf(sys.version_info[0] == 3 and
                 ...
                 'Due to a known issue in avro-python3 package, it '
                 'is recommended to use fastavro with Beam Avro IO '
                 'on Python 3 until BEAM-6522 is addressed. ')
class TestAvro(AvroBase, unittest.TestCase):
  ...
  @unittest.skip('Skipped during debugging')
  def test_dynamic_work_rebalancing_exhaustive(self):
