...
DISTRIBUTION_INT64_TYPE = 'beam:metrics:DistributionInt64'
LATEST_INT64_TYPE = 'beam:metrics:LatestInt64'
...
def create_monitoring_info(urn, type_urn, metric_proto, labels=dict()):
  ...
  Args:
    ...
    type_urn: The URN of the type of the monitoring info/metric.
        i.e. beam:metrics:SumInt64, beam:metrics:LatestInt64.
