...
class Pipeline(object):
  ...
  def __init__(self, runner=None, options=None, argv=None):
    ...
    self.transforms_stack = [AppliedPTransform(
        parent=None, transform=None, full_label='root', inputs=None)]
  ...
  def to_runner_api(self, return_context=False, context=None):
    ...
    proto = beam_runner_api_pb2.Pipeline(
        root_transform_ids=[
            context.transforms.get_id(part) for part in self._root_transform().parts],
  ...
  def from_runner_api(proto, runner, options, return_context=False):
    ...
    root_transform = AppliedPTransform(
        parent=None, transform=None, full_label='root', inputs=None)
    root_transform.parts = [
        context.transforms.get_by_id(root_id)
        for root_id in proto.root_transform_ids]
    p.transforms_stack = [root_transform]
