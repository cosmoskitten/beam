...
class Pipeline(object):
  ...
  def __init__(self,
    ...
    self.transforms_stack = [
        # An AppliedPTransform with PTransform of None is not entirely safe as
        # there are a number of unchecked usages
        AppliedPTransform(None, None, '', None)  # type: ignore
    ]
