...
class ToString(object):
  ...
  class Kvs(ptransform.PTransform):
    ...
    def expand(self, pcoll):
      ...
      return (pcoll | ('%s:KeyVaueToString' % self.label >> (core.Map(
  ...
  class Element(ptransform.PTransform):
    ...
    def expand(self, pcoll):
      input_type = T
      output_type = List[str]
      return (pcoll | ('%s:ElementToString' % self.label >> (core.Map(
          lambda x: str(x)))
                       .with_input_types(input_type)
                       .with_output_types(output_type)))
  ...
  class Iterables(ptransform.PTransform):
    ...
    def expand(self, pcoll):
      ...
      return (pcoll | ('%s:IterablesToString' % self.label >> (
          core.Map(lambda x: self.delimiter.join(str(_x) for _x in x)))
                       .with_input_types(input_type)
                       .with_output_types(output_type)))
