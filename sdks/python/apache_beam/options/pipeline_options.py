...
class GoogleCloudOptions(PipelineOptions):
  ...
  def validate(self, validator):
    ...
    if validator.is_service_runner():
      ...
      errors.extend(
          validator.validate_gcs_path(self.view_as(StandardOptions),
                                      'temp_location'))
      if getattr(self, 'staging_location', None) or getattr(
          self.view_as(StandardOptions), 'temp_location', None) is None:
