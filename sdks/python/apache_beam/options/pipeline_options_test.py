...
class GoogleCloudOptionsTest(unittest.TestCase):
  ...
  def test_preferred_over_temp_location(self):
    options = PipelineOptions(
        temp_location="abc", gcp_temp_location="gs://asdf")
  ...
  def test_fall_back_to_temp_location(self):
    ...
    with warnings.catch_warnings():
      ...
      self.assertEqual(
          options.view_as(GoogleCloudOptions).gcp_temp_location, "abc")
  ...
  def test_deprecation_warning(self):
    ...
    with self.assertWarns(BeamDeprecationWarning):
      _ = options.view_as(GoogleCloudOptions).gcp_temp_location
    with self.assertWarns(BeamDeprecationWarning):
      options.view_as(GoogleCloudOptions).gcp_temp_location = "gs://asdf"
