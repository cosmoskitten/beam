...
OLD_RUNNER_HARNESS_PARDO_URN = 'urn:beam:dofn:javasdk:0.1'
OLD_RUNNER_HARNESS_READ_URN = 'urn:org.apache.beam:source:java:0.1'
...
@BeamTransformFactory.register_urn(OLD_RUNNER_HARNESS_READ_URN, None)
...
@BeamTransformFactory.register_urn(OLD_RUNNER_HARNESS_PARDO_URN, None)
def create(factory, transform_id, transform_proto, parameter, consumers):
