...
class PerWindowInvoker(DoFnInvoker):
  ...
  def __init__(self, output_processor, signature, context,
    ...
    # Only attempt to cache additional arguments on the first element if all
    # inputs are within the global window.
    self._cached_globally_windowed_args = not self.has_windowed_inputs
