...
class TestNativeSink(unittest.TestCase):
  ...
  def test_repr_method(self):
    class FakeSink(NativeSink):
      ...
      def __init__(self, dataset=None, project=None, schema=None,
                   create_disposition='create', write_disposition=None,
