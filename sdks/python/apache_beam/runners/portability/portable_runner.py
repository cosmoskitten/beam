...
class PortableRunner(runner.PipelineRunner):
  ...
  def _create_environment(options):
    ...
    if portable_options.python_environment_type == 'DOCKER':
      environment_urn = common_urns.environments.DOCKER.urn
    elif portable_options.python_environment_type == 'PROCESS':
    ...
    if environment_urn == common_urns.environments.DOCKER.urn:
      ...
      config = json.loads(portable_options.python_environment_config)
      return beam_runner_api_pb2.Environment(
