...
class BeamFnExternalWorkerPoolServicer(
  ...
  def __init__(self, worker_threads, use_threads=False):
    self._worker_threads = worker_threads
    self._use_threads = use_threads

  @classmethod
  def start(cls, worker_threads=1, use_threads=False):
    ...
    beam_fn_api_pb2_grpc.add_BeamFnExternalWorkerPoolServicer_to_server(
        cls(worker_threads, use_threads=use_threads), worker_server)
    worker_server.start()
