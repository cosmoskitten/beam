...
class TransformEvaluatorRegistry(object):
  ...
  _test_evaluators_overrides = {}  # type: Dict[Type[core.PTransform], _TransformEvaluator]
  ...
  def __init__(self, evaluation_context):
    ...
    }  # type: Dict[Type[core.PTransform], _TransformEvaluator]
...
class _PubSubReadEvaluator(_TransformEvaluator):
  ...
  _subscription_cache = {}  # type: Dict[AppliedPTransform, _PubSubSubscriptionWrapper]
