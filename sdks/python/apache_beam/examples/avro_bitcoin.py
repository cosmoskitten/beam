...
"""Collect statistics on transactions in a public bitcoin dataset that was exported to avro"""
...
def run(argv=None):
    ...
    records = p | 'read' >> ReadFromAvro(opts.input, use_fastavro=opts.use_fastavro)
