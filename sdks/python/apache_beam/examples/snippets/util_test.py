...
class UtilTest(unittest.TestCase):
  ...
  def test_parse_example_int_argument(self):
    # python path/to/snippets.py example 42
    argv = ['example', '42']
    self.assertEqual(parse_example(argv), "example(42)")

  def test_parse_example_expression_argument(self):
    # python path/to/snippets.py example '42+1'
    argv = ['example', '41+1']
    self.assertEqual(parse_example(argv), "example(42)")
