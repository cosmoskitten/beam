...
def getcallargs_forhints_impl_py3(func, packed_typeargs, typekwargs):
  try:
    ...
    return {}
  try:
    bindings = signature.bind_partial(*packed_typeargs, **typekwargs)
  except TypeError as e:
    # Might be raised due to too many arguments.
    raise TypeCheckError(e)
