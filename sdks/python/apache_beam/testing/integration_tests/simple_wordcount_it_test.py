...
"""A end-to-end integration test for simple version of wordcount pipeline."""
...
def run_wordcount(argv):
  ...
  DoFn class with transform function due to BEAM-6158."""
...
class SimpleWordCountIT(unittest.TestCase):
  ...
  @attr('Py3IT')
  def test_simple_wordcount_it(self):
    ...
    pipeline_verifiers = [PipelineStateMatcher(),
                          FileChecksumMatcher(output + '*-of-*',
                                              ...
                                              sleep_secs)]
    extra_opts = {'experiment': 'beam_fn_api',  # Enable FnAPI mode
                  'output': output,
