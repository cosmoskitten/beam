...
# TODO: remove
# Print out GCP service account.
gcloud config list || true
gcloud kms keys list --location global --keyring=beam-it || true
echo "test" > 1
gcloud kms encrypt --plaintext-file 1 --ciphertext-file 1.enc --key projects/apache-beam-testing/locations/global/keyRings/beam-it/cryptoKeys/test
