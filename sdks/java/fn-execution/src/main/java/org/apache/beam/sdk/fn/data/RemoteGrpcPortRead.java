...
public class RemoteGrpcPortRead {
  ...
  public boolean equals(Object other) {
    if (!(other instanceof RemoteGrpcPortRead)) {
      return false;
    }
    RemoteGrpcPortRead that = (RemoteGrpcPortRead) other;
    return Objects.equals(this.localOutputId, that.localOutputId)
        && Objects.equals(this.port, that.port);
  }

  @Override
  public int hashCode() {
    return Objects.hash(localOutputId, port);
  }
}
