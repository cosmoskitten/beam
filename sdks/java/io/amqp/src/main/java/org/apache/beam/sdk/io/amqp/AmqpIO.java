...
public class AmqpIO {
  ...
  private static class UnboundedAmqpSource extends UnboundedSource<Message, AmqpCheckpointMark> {
    ...
    @Override
    public Coder<Message> getDefaultOutputCoder() { return new AmqpMessageCoder(); }
  ...
  static class AmqpMessageCoder extends CustomCoder<Message> {
    ...
    public void encode(Message value, OutputStream outStream) throws CoderException, IOException {
      ProtonJMessage message = (ProtonJMessage) value;
      ByteBuffer buffer = ByteBuffer.wrap(new byte[1024 * 4]);
      DroppingWritableBuffer overflow = new DroppingWritableBuffer();
      int c = message.encode(new CompositeWritableBuffer(
