 ...
 *
 * <p>To configure a JMS source, you have to provide a {@code javax.jms.ConnectionFactory}
...
public class JmsIO {
  ...
  public static class Read extends PTransform<PBegin, PCollection<JmsRecord>> {
    ...
    public void validate(PBegin input) {
      if (connectionFactory == null) {
        throw new IllegalArgumentException("ConnectionFactory not specified");
      }
      if (queue == null && topic == null) {
        throw new IllegalArgumentException("Either queue or topic not specified");
      }
    }
    ...
    public void populateDisplayData(DisplayData.Builder builder) {
      ...
      if (queue != null) {
        builder.add(DisplayData.item("queue", queue));
      }
      if (topic != null) {
  ...
  private static class UnboundedJmsSource extends UnboundedSource<JmsRecord, JmsCheckpointMark> {
    ...
    public List<UnboundedJmsSource> generateInitialSplits(
      ...
      return Collections.singletonList(new UnboundedJmsSource(connectionFactory, queue, topic));
    }
    ...
    public void validate() {
      if (connectionFactory == null) {
        throw new IllegalArgumentException("ConnectionFactory is not defined");
      }
      if (queue == null && topic == null) {
        throw new IllegalArgumentException("Either queue or topic is not defined");
      }
    }
  ...
  private static class UnboundedJmsReader extends UnboundedReader<JmsRecord> {
    ...
    public boolean advance() throws IOException {
      try {
        ...
        JmsRecord jmsRecord = new JmsRecord(headers, properties, message.getText());
    ...
    public CheckpointMark getCheckpointMark() {
      return new JmsCheckpointMark(destination,
          currentRecord.getHeaders().get("JMSMessageID").toString());
    }
