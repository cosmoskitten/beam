 ...
 *
 * <p>pipeline .apply(HCatalogIO.read() .withConfigProperties(configProperties)
 * .withDatabase("default") //optional, assumes default if none specified .withTable("employee")
 ...
 * Terminate after 60 seconds .withPartitionCols(partitions) // List of partition cols-used as a
 * filter
 *
