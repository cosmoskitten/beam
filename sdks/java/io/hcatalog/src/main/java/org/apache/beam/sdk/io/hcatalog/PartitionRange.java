...
public class PartitionRange implements Serializable,
    HasDefaultTracker<PartitionRange, PartitionRangeTracker> {
  ...
  public PartitionRange(
      ImmutableList<Partition> partitions, SerializableComparator<Partition> comparator, Partition lastCompleted) {
