...
public class SnsIOTest implements Serializable {
  ...
  @Rule
  public SnsIOPipelineOptions options =
      TestPipeline.testingPipelineOptions().as(SnsIOPipelineOptions.class);

  @Rule public Pipeline p = TestPipeline.create(options);
  @Rule public final transient ExpectedLogs expectedLogs = ExpectedLogs.none(SnsIO.class);

  private interface SnsIOPipelineOptions extends TestPipelineOptions {}
