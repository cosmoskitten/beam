...
public class HDFSFileSinkTest {
  ...
  private <T> void doWrite(Sink<T> sink,
    ...
    writeOperation.finalize(Arrays.asList(writeResult), options);
  }
  ...
  public void testWriteSingleRecord() throws Exception {
    ...
    doWrite(sink, options, Arrays.asList(foobar));
  ...
  public void testToText() throws Exception {
    ...
    assertEquals(Arrays.asList(foobar), strings);
  }
  ...
  public void testToAvro() throws Exception {
    ...
    doWrite(sink, options, Arrays.asList(new GenericClass(3, "foobar")));
