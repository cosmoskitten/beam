...
public class SimpleAuthHDFSFileSource<K, V> extends HDFSFileSource<K, V> {
   ...
   * {@link org.apache.hadoop.mapreduce.lib.input.FileInputFormat}, with key-value types specified
   ...
   * ("glob") using the given Hadoop {@link org.apache.hadoop.mapreduce.lib.input.FileInputFormat},
