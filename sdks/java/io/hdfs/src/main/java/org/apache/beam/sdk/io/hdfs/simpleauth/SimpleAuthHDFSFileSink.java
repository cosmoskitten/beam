...
public class SimpleAuthHDFSFileSink<K, V> extends HDFSFileSink<K, V> {
  ...
  /** {{@link org.apache.beam.sdk.io.Sink.WriteOperation}} for HDFS with Simple Authentication. */
  public static class SimpleAuthHadoopWriteOperation<K, V> extends HDFSWriteOperation<K, V> {
    private final String username;
  ...
  /** {{@link org.apache.beam.sdk.io.Sink.Writer}} for HDFS files with Simple Authentication. */
  public static class SimpleAuthHDFSWriter<K, V> extends HDFSWriter<K, V> {
    private final UserGroupInformation ugi;

    public SimpleAuthHDFSWriter(SimpleAuthHadoopWriteOperation<K, V> writeOperation,
                                String path,
                                Class<? extends FileOutputFormat<K, V>> formatClass,
                                String username) {
