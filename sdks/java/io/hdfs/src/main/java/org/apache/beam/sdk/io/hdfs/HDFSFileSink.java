...
public class HDFSFileSink<K, V> extends Sink<KV<K, V>> {
  ...
  /** {{@link org.apache.beam.sdk.io.Sink.WriteOperation}} for HDFS. */
  ...
  /** {{@link org.apache.beam.sdk.io.Sink.Writer}} for HDFS files. */
  public static class HDFSWriter<K, V> extends Writer<KV<K, V>, String> {
    ...
    public void open(String uId) throws Exception {
      ...
      JobID jobId = ((HDFSWriteOperation) writeOperation).jobID();
