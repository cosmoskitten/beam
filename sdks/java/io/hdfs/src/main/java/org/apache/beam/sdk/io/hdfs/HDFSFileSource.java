 ...
 * HDFS files, use {@link HDFSFileSource#from} to specify the path(s) of the files to
 * read, the HDFS {@link org.apache.hadoop.mapreduce.lib.input.FileInputFormat}, the
