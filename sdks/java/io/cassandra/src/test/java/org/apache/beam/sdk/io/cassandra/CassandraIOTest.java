...
public class CassandraIOTest implements Serializable {
  ...
  private static final String TEMPORARY_FOLDER = System.getProperty("java.io.tmpdir");
  ...
  public static void beforeClass() throws Exception {
    ...
    String commitLog = TEMPORARY_FOLDER + "/embedded-cassandra/commit-log";
    Files.createDirectories(Paths.get(commitLog));
    String cdcRaw = TEMPORARY_FOLDER + "/embedded-cassandra/cdc-raw";
    Files.createDirectories(Paths.get(cdcRaw));
    String hints = TEMPORARY_FOLDER + "/embedded-cassandra/hints";
    Files.createDirectories(Paths.get(hints));
    String savedCache = TEMPORARY_FOLDER + "/embedded-cassandra/saved-cache";
  ...
  public static void afterClass() throws InterruptedException, IOException {
    ...
    FileUtils.deleteDirectory(new File(TEMPORARY_FOLDER + "/embedded-cassandra/"));
  }
