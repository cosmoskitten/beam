 ...
 *
 * <p>To Implement a custom mapper you need to: 1) Create a concrete implementation of {@link
 * Mapper} 2) Create a factory that implements SerializableFunction<Session, Mapper> (see {@link
 * DefaultObjectMapperFactory}) 3) Pass the mapper-factory in 2) through withMapperFactoryFn() in
 * the CassandraIO builder. Example:
 *
 * <pre>{@code
...
public interface Mapper<T> {
  ...
  /**
   * This method gets called for each delete event. The input argment is the Object that should be
  ...
  /**
   * This method gets called for each save event. The input argment is the Object that should be
