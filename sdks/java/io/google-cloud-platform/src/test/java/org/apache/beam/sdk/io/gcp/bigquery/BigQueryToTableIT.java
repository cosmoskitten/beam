...
public class BigQueryToTableIT {
  ...
  private String big_query_dataset_id = "bq_query_to_table";
  ...
  private void setupNewTypesQueryTest() {
    ...
    this.options.setQuery(
        String.format(
            ...
            project, this.big_query_dataset_id, BigQueryToTableIT.NEW_TYPES_QUERY_TABLE_NAME));
  ...
  public void setupBqEnvironment() {
    ...
    this.big_query_dataset_id += ("_" + timeSeed.toString() + "_" + random.toString());
    ...
    bqClient.createNewDataset(project, this.big_query_dataset_id);
    outputTable =
        project + ":" + this.big_query_dataset_id + "." + BigQueryToTableIT.OUTPUT_TABLE_NAME;
  }

  @After
  public void cleanBqEnvironment() {
    bqClient.deleteDataset(project, this.big_query_dataset_id);
  }
