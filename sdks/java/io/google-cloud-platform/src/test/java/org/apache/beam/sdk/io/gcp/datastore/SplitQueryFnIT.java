 ...
 *
 * <pipeline>It is hard to mock the exact behavior of Cloud Datastore, especially for the statistics
 ...
 *
 * <pipeline>These tests are brittle as they rely on statistics data in Cloud Datastore. If the data
