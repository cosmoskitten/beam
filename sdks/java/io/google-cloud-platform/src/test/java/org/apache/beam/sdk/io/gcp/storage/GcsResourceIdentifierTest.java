...
/**
 * Tests for {@link GcsResourceIdentifier}.
 */
@RunWith(JUnit4.class)
public class GcsResourceIdentifierTest {
  ...
  private GcsResourceIdentifier toResourceIdentifier(String str) throws Exception {
    return GcsResourceIdentifier.fromGcsPath(GcsPath.fromUri(str));
  }
}
