...
public class BigQueryIOStorageReadTest {
  ...
  private static ReadRowsResponse createResponse(
      Schema schema, Collection<GenericRecord> genericRecords, double fractionConsumed) throws Exception {
    ...
    return ReadRowsResponse.newBuilder()
        ...
        .setStatus(StreamStatus.newBuilder()
            // TODO(aryann): Once we rebuild the generated client code, we should change this to
                ...
                UnknownFieldSet.newBuilder()
                    .addField(
                        ...
                        UnknownFieldSet.Field.newBuilder()
                            .addFixed32(java.lang.Float.floatToIntBits((float) fractionConsumed))
                            .build())
                    .build()))
        .build();
  }
  ...
  public void testFractionConsumed() throws Exception {
    ...
    List<ReadRowsResponse> responses =
        Lists.newArrayList(
            ...
            createResponse(AVRO_SCHEMA, records.subList(4, 5), 0.9375));
