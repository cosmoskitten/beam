...
/**
 * {@link ResourceIdentifier} implementation for Google Cloud Storage.
 */
public class GcsResourceIdentifier implements ResourceIdentifier {

  private final GcsPath gcsPath;

  static GcsResourceIdentifier fromGcsPath(GcsPath gcsPath) {
    return new GcsResourceIdentifier(gcsPath);
  }

  private GcsResourceIdentifier(GcsPath gcsPath) {
  ...
  public String toString() {
    return String.format("GcsResourceIdentifier: [%s]", gcsPath);
  }

  @Override
  public boolean equals(Object obj) {
    if (!(obj instanceof GcsResourceIdentifier)) {
      return false;
    }
    GcsResourceIdentifier other = (GcsResourceIdentifier) obj;
