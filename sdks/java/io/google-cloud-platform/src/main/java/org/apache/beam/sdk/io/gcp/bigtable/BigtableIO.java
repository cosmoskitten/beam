 ...
 * after writes have completed.  See {@link org.apache.beam.sdk.transforms.Wait} for details on
 * the windowing requirements of the signal and input PCollections.
 *
 * <pre>{@code
 * // See Wait.on
 * PCollection<KV<ByteString, Iterable<Mutation>>> data = ...;
...
public class BigtableIO {
  ...
  public static class WriteWithResults
    ...
    @Override
    public String toString() {
      return MoreObjects.toStringHelper(Write.class).add("config", bigtableConfig).toString();
    }
  }
