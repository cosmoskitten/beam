...
class BigQueryServicesImpl implements BigQueryServices {
  ...
  static class JobServiceImpl implements BigQueryServices.JobService {
    ...
    private static void startJob(Job job,
      ...
      BackOff backoff =
          FlexibleBackoff.of()
              .withMaxAttempts(MAX_RPC_ATTEMPTS).withInitialBackoff(INITIAL_RPC_BACKOFF);
    ...
    public Job pollJob(JobReference jobRef, int maxAttempts)
      ...
      BackOff backoff =
          FlexibleBackoff.of()
              .withMaxAttempts(maxAttempts).withInitialBackoff(INITIAL_JOB_STATUS_POLL_BACKOFF);
  ...
  static class DatasetServiceImpl implements DatasetService {
    ...
    public long insertAll(
      ...
      BackOff backoff =
          FlexibleBackoff.of()
              .withMaxAttempts(MAX_INSERT_ATTEMPTS)
