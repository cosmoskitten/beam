 ...
 *             String stock = quote.getStock().toString();
 *             return new TableDestination(
 *                 "my-project:output.quotes_" + stock, // Table spec
 *                 "Quotes of stock " + stock // Table description
 *               );
 *           });
 * }</pre>
 *
