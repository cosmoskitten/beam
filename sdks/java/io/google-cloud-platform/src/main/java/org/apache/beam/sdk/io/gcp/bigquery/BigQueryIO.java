...
public class BigQueryIO {
  ...
  public abstract static class Write<T> extends PTransform<PCollection<T>, WriteResult> {
     ...
     * {@link #enableClustering()} is also set so that the clustering configurations get
     ...
     *
     * Setting this option enables use of {@link TableDestinationCoderV3} which encodes clustering
     * information. Pipelines using an older coder must be drained before setting this option,
     * since {@link TableDestinationCoderV3} will not be able to read state written with a previous
     * version.
     */
