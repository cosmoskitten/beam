 ...
 * The BYTES data type requires that bytes are encoded using base64 encoding when writing to
 * BigQuery. When bytes are read from BigQuery they are returned as base64 encoded bytes.
 *
 * <h3>Reading</h3>
 *
