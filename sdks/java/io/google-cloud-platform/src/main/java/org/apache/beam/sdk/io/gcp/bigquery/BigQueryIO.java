 ...
 * be specified.
 *
 * <p>If you are reading from an authorized view wih {@link TypeRead#fromQuery}, you need to use
 * {@link TypeRead#withQueryLocation(String)} to set the location of the BigQuery job. Otherwise,
