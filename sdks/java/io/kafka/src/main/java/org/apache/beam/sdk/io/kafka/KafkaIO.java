...
public class KafkaIO {
  ...
  public abstract static class Read<K, V>
     ...
     * behind wall time, if idleWaterMarkDelta is not set the watermark does not advance. Every record
    ...
    public Read<K, V> withLogAppendTime(Optional<Duration> idleWaterMarkDelta) {
      return withTimestampPolicyFactory(TimestampPolicyFactory.withLogAppendTime(idleWaterMarkDelta));
    }
