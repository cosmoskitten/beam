...
public class HadoopFileSystemTest {
            ...
            MatchResult.create(
                ...
                ImmutableList.of(
                    Metadata.builder()
                        ...
                        .setLastModified(lastModified("testFileB"))
                        .build()))));
  }
            ...
            MatchResult.create(
                ...
                ImmutableList.of(
                    Metadata.builder()
                        ...
                        .setLastModified(lastModified("testFileBB"))
                        .build())));
    ...
    assertThat(
        ...
        containsInAnyOrder(
            Metadata.builder()
                ...
                .setIsReadSeekEfficient(true)
                .setSizeBytes("testDataA".getBytes(StandardCharsets.UTF_8).length)
                .setLastModified(lastModified("renameFileA"))
                .build(),
            Metadata.builder()
                .setResourceId(testPath("renameFileB"))
                .setIsReadSeekEfficient(true)
                .setSizeBytes("testDataB".getBytes(StandardCharsets.UTF_8).length)
                .setLastModified(lastModified("renameFileB"))
                .build()));
  ...
  private long lastModified(String relativePath) throws Exception {
    return fileSystem.fileSystem.getFileStatus(testPath(relativePath).toPath()).getModificationTime();
  }
