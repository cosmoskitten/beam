 ...
 * HadoopInputFormatIO } source returns immutable records for a scenario when RecordReader returns
 * the same key and value objects with updating values every time it reads data.
 */
