 ...
 *
 */
<<<<<<< HEAD:sdks/java/io/hadoop-input-format/src/main/java/org/apache/beam/sdk/io/hadoop/inputformat/HadoopInputFormatIOContants.java
...
<<<<<<< HEAD
>>>>>>> Name of Constants file rectified:sdks/java/io/hadoop-input-format/src/main/java/org/apache/beam/sdk/io/hadoop/inputformat/HadoopInputFormatIOConstants.java
...
=======
  ...
  public static final String WRONG_INPUTFORMAT_VALUE_CLASS_ERROR_MSG =
      "Wrong InputFormat value class in configuration : Expected value.class is %s but was %s.";
  public static final String WRONG_KEY_TRANSLATIONFUNC_ERROR_MSG =
      "Key translation's input type is not same as hadoop InputFormat : %s key class : %s";
  public static final String WRONG_VALUE_TRANSLATIONFUNC_ERROR_MSG =
      "Value translation's input type is not same as hadoop InputFormat :  %s value class : %s";
  public static final String CANNOT_FIND_CODER_ERROR_MSG = "Cannot find coder for %s  : ";
  public static final String COMPUTESPLITS_NULL_GETSPLITS_ERROR_MSG =
      "Error in computing splits, getSplits() returns null.";
  public static final String COMPUTESPLITS_NULL_SPLIT_ERROR_MSG =
