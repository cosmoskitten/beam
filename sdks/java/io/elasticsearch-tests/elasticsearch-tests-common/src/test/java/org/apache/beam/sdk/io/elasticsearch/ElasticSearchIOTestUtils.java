...
class ElasticSearchIOTestUtils {
  ...
  public static void setIndexMapping(ConnectionConfiguration connectionConfiguration, RestClient restClient)
      throws IOException {
    ...
    String requestString =
        String.format(
            ...
            connectionConfiguration.getType(), getBackendVersion(connectionConfiguration) == 2 ? "string" : "text");
