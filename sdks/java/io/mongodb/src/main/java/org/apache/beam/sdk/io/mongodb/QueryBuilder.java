...
public class QueryBuilder {
  ...
  private List<BsonDocument> aggregation;
  ...
  public QueryBuilder withAggregation(List<BsonDocument> aggregation) {
  ...
  public MongoCursor<Document> cursor() {
    ...
    if (!this.aggregation.isEmpty() && (this.documentIdStr != null || this.documentId != null || this.filter != null)) {
      throw new InvalidParameterException("Cannot set both aggregates,and a document ID or a filter");
    }
    ...
    if (!this.aggregation.isEmpty()) {
      mongoDbPipeline = this.aggregation;
    } else {
