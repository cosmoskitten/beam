 ...
 * value class other than InputFormat's actual key or value class then, it may result in an error
 * like "unexpected extra bytes after decoding" while the decoding process of key/value object
 * happens. Hence, it is important to set appropriate InputFormat key and value class.
 *
