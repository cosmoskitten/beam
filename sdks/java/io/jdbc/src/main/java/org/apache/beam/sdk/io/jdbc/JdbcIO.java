...
public class JdbcIO {
  ...
  public static class PoolableDataSourceProvider
      extends DataSourceProviderFnFromDataSourceConfiguration {

    private PoolableDataSourceProvider(DataSourceConfiguration config) {
      super(config);
    }

    public static PoolableDataSourceProvider of(DataSourceConfiguration config) {
      return new PoolableDataSourceProvider(config);
    }

    @Override
    public DataSource apply(Void input) {
      DataSource current = super.apply(input);
