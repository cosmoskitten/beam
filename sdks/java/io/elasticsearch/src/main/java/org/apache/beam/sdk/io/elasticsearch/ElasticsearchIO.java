 ...
 *
 * <p>Optionally, you can provide {@code withIdFn()} to make use of explicit identifiers rather than
 * using those auto-generated by Elasticseach.
 *
 * <p>Optionally, you can provide {@code withIndexFn()} and {@code withTypeFn()} to provide
 * per-document routing to the target Elasticsearch index and type. 
 */
...
public class ElasticsearchIO {
  ...
  public abstract static class Write extends PTransform<PCollection<String>, PDone> {
    ...
    /**
     * Interface allowing a specific field value be returned from a parsed JSON document. This is
     ...
     * as a failure.
     */
    public interface FieldExtractFn extends SerializableFunction<JsonNode, String> {}
    ...
    @Nullable
    abstract FieldExtractFn getIdFn();

    @Nullable
    abstract FieldExtractFn getIndexFn();

    @Nullable
    abstract FieldExtractFn getTypeFn();
    ...
    abstract static class Builder {
      ...
      abstract Builder setIdFn(FieldExtractFn idFunction);

      abstract Builder setIndexFn(FieldExtractFn indexFn);

      abstract Builder setTypeFn(FieldExtractFn typeFn);
     ...
     */
    public Write withIdFn(FieldExtractFn idFn) {
     ...
     * @return the {@link Write} with the function set
     */
    public Write withIndexFn(FieldExtractFn indexFn) {
     ...
     * @return the {@link Write} with the function set
     */
    public Write withTypeFn(FieldExtractFn typeFn) {
    ...
    static class WriteFn extends DoFn<String, Void> {
       ...
       * {@link FieldExtractFn} configured. This allows any or all of the index, type and document
       * id to be controlled on a per document basis. If none are provided the an empty default of
      ...
      private void flushBatch() throws IOException {
        ...
        // document meta (i.e. using {@link SolrIO} with the {@link FieldExtractFn} options)
        String endPoint =
            String.format(
                "/%s/%s/_bulk",
