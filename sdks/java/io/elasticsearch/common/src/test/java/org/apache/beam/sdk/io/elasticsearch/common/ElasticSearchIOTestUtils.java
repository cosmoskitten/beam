...
/** Test utilities to use with {@link ElasticsearchIOCore}. */
public class ElasticSearchIOTestUtils {
  ...
  public static void deleteIndex(String index, RestClient restClient) throws IOException {
    try {
  ...
  public static void insertTestDocuments(String index, String type, long numDocs,
    ...
    JsonNode searchResult = ElasticsearchIOCore.parseResponse(response);
   ...
   */
  public static long refreshIndexAndGetCurrentNumDocs(String index, String type,
      RestClient restClient) throws IOException {
    long result = 0;
    try {
