...
/**
 * Manipulates test data used by the {@link ElasticsearchIOCore}
 * integration tests.
 *
...
public class ElasticsearchTestDataSet {
   ...
   * -Dexec.mainClass=org.apache.beam.sdk.io.elasticsearch.common.ElasticsearchTestDataSet \
  ...
  public static ElasticsearchIOCore.ConnectionConfiguration getConnectionConfiguration(
      IOTestPipelineOptions options, ReadOrWrite rOw) {
    ElasticsearchIOCore.ConnectionConfiguration connectionConfiguration =
        ElasticsearchIOCore.ConnectionConfiguration.create(
            new String[] {
              "http://"
  ...
  public static void deleteIndex(RestClient restClient, ReadOrWrite rOw) throws Exception {
