...
public class NamedTestResult implements TestResult {
  ...
  private NamedTestResult(String testID, String timestamp, String metric, long value) {
    this.testID = testID;
   ...
   */
  public static NamedTestResult create(String testID, String timestamp, String metric, long value) {
