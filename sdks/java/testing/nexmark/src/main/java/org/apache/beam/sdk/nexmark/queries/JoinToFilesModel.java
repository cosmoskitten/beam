...
/** A direct implementation of {@link JoinToFiles}. */
public class JoinToFilesModel extends NexmarkQueryModel {
  ...
  public JoinToFilesModel(NexmarkConfiguration configuration) {
    super(configuration);
  }
