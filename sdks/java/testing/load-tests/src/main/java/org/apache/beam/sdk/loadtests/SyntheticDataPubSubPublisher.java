 ...
 *  </pre>
 *  Parameter kafkaBootstrapServerAddress is optional.
 *  If supplied, pipeline topic will be treated as Kafka topic name and records will be published to Kafka instead of PubSub.
 */
public class SyntheticDataPubSubPublisher {
  ...
  public static class MapKVToString
