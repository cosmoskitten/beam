...
public class ResultPublisher {
  ...
  public void toConsole() {
    ...
    long totalBytes = reader.getCounterMetric(TOTAL_BYTES_COUNT, -1);
    long startTime = reader.getStartTimeMetric(now, RUNTIME);
    long endTime = reader.getEndTimeMetric(now, RUNTIME);
