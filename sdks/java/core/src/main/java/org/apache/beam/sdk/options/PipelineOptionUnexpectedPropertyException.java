...
public class PipelineOptionUnexpectedPropertyException extends IllegalArgumentException {
  ...
  public static PipelineOptionUnexpectedPropertyException create(
      Class optionClass, String propertyName, SortedSet<String> bestMatches) {
    String errorMessage = createErrorMessage(optionClass, propertyName, bestMatches);
    PipelineOptionUnexpectedPropertyException exception =
        new PipelineOptionUnexpectedPropertyException(errorMessage, propertyName, bestMatches);
    return exception;
  }
