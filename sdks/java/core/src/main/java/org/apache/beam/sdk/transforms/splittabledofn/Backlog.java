 ...
 *
 * <p>It is up to each restriction tracker to convert between their natural representation
 * of outstanding work and this representation. For example:
 * <ul>
 ...
 *   end key to be zero and interpolate the position of the next splittable key as the backlog.
 *   If information about the probability density function or cumulative distribution function
 *   is available, backlog interpolation can be improved. Alternatively, if the number of encoded
