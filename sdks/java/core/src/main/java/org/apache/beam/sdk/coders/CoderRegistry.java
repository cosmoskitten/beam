 ...
 *
 * <p>By default, the {@link CoderFactory coder factory} registration order is as follows:
 * <ul>
 ...
 *       a {@link ServiceLoader}.</li>
 * </ul>
 *
 * <p>{@link CoderRegistry} uses the following mechanisms to determine a {@link Coder} for a
 * Java class:
 */
public class CoderRegistry {
  ...
  static {
    ...
    codersToRegister.add(CoderFactories.fromStaticMethods(Byte.class, ByteCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(BitSet.class, BitSetCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Double.class, DoubleCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Instant.class, InstantCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Integer.class, VarIntCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Iterable.class, IterableCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(KV.class, KvCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(List.class, ListCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Long.class, VarLongCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Map.class, MapCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Set.class, SetCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(String.class, StringUtf8Coder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(
        TimestampedValue.class, TimestampedValue.TimestampedValueCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(Void.class, VoidCoder.class));
    codersToRegister.add(CoderFactories.fromStaticMethods(byte[].class, ByteArrayCoder.class));
    codersToRegister.add(
  ...
  private Coder<?> createCoderFromFactories(
    ...
    for (CoderFactory coderFactory : coderFactories) {
      try {
        ...
        // This coder factory is unable to provide a coder, move onto the next one.
      }
    }

    // Build up the error message and list of causes.
    StringBuilder messageBuilder = new StringBuilder()
        .append("Unable to provide a default Coder for ").append(typeDescriptor)
