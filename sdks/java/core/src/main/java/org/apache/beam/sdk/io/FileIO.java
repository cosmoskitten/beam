...
public class FileIO {
  ...
  public abstract static class Write<DestinationT, UserT>
    ...
    /**
     * Like {@link #via(Fn, Fn)}, but uses the same sink for all
     * destinations.
     */
    public <OutputT> Write<DestinationT, UserT> via(
    ...
    /**
     * Like {@link #via(Fn, Fn)}, but the output type of the
    ...
    /**
     * Like {@link #via(Fn)}, but uses the same {@link Sink} for all destinations.
     */
    ...
    /**
     * Like {@link #to(Fn)} but uses the same {@link FilenamePolicy} for all
     * destinations.
     */
