...
public class FlatMapElements<InputT, OutputT>
   ...
   *
   * <p>The user must call {@code via} on the returned {@link FlatMapWithExceptions} instance to define
  ...
  public FlatMapWithExceptions<InputT, OutputT, ?> withExceptions() {
    return new FlatMapWithExceptions<>(fn, originalFnForDisplayData, inputType, outputType, null, null);
  }
