...
public class FileSystems {
  ...
  public abstract static class MockFileSystem extends FileSystem {
    @Override
    public abstract WritableByteChannel create(ResourceId uri, CreateOptions options)
        throws IOException;
    @Override
    public abstract ReadableByteChannel open(ResourceId uri) throws IOException;
