...
public class SdkComponents {
  ...
  /**
   * Puts the provided {@link AppliedPTransform} into this {@link SdkComponents}.
   *
   ...
   */
  public RunnerApi.Components toComponents() throws IOException {
    RunnerApi.Components.Builder componentsBuilder = RunnerApi.Components.newBuilder();
    // TODO: Implement in Coders
    //    for (Map.Entry<Coder<?>, String> coderEntry : coderIds.entrySet()) {
    //      RunnerApi.Coder coderProto = Coders.toProto(coderEntry.getKey(), this);
    //      componentsBuilder.putCoders(coderEntry.getValue(), coderProto);
    //    }
    // TODO: Implement in WindowingStrategies
    //    for (Map.Entry<WindowingStrategy<?, ?>, String> strategyEntry :
    //        windowingStrategyIds.entrySet()) {
    //      RunnerApi.WindowingStrategy strategyProto =
    //          WindowingStrategies.toProto(strategyEntry.getKey(), this);
    //      componentsBuilder.putWindowingStrategies(strategyEntry.getValue(), strategyProto);
    //    }
    // TODO: implement
    //    for (Map.Entry<PCollection<?>, String> collectionEntry : collectionIds.entrySet()) {
    //      RunnerApi.PCollection pCollectionProto =
    //          PCollections.toProto(collectionEntry.getKey(), this);
    //      componentsBuilder.putPcollections(collectionEntry.getValue(), pCollectionProto);
    //    }
    // TODO: implement
    //    for (Map.Entry<AppliedPTransform<?, ?, ?>, String> transformEntry
    //                  : transformIds.entrySet()) {
    //      RunnerApi.PTransform ptransformProto =
    //          PTransforms.toProto(transformEntry.getKey(), this);
    //      componentsBuilder.putTransforms(transformEntry.getValue(), ptransformProto);
    //    }
