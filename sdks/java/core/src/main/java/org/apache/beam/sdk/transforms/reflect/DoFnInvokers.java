...
//  private static Implementation onTimerDelegation(DoFnSignature signature) {
//    return new OnTimerMethodDelegation(signature.onTimerMethods());
//  }
  ...
  private static final class OnTimerInvokerInitialization {
    public static void initialize(@This DoFnInvokerBase invoker, @Argument(0) DoFn<?, ?> fn) {
