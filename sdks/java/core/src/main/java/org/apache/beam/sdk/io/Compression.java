...
public enum Compression {
   ...
   * responsibility to declare an explicit dependency on {@code zstd-jni}. Attempts to read
   * or write .zst files without {@code zstd-jni} loaded will result in {@code NoClassDefFoundError}
   * at runtime.
   */
  ZSTD(".zst", ".zst", ".zstd") {
    @Override
