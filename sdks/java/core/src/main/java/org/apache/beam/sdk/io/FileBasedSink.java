...
public abstract class FileBasedSink<T> implements Serializable, HasDisplayData {
  ...
  public static final class FileResultCoder extends AtomicCoder<FileResult> {
    ...
    public void encode(FileResult value, OutputStream outStream, Context context)
      ...
      stringCoder.encode(value.getTempFilename().toString(), outStream, context.nested());
      ...
      integerCoder.encode(value.getShard(), outStream, context);
    }
    ...
    public FileResult decode(InputStream inStream, Context context)
      ...
      int shard = integerCoder.decode(inStream, context);
