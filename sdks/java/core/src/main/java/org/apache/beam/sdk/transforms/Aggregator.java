...
public interface Aggregator<InputT, OutputT> {
  ...
  interface AggregatorFactory {
     ...
     *
     *  <p>This method is called to create an aggregator for a {@link OldDoFn}. It receives the class
     *  of the {@link OldDoFn} being executed and the context of the step it is being executed in.
     */
