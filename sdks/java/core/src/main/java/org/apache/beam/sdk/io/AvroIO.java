 ...
 * {@link Write#to(FilenamePolicy)} to
 ...
 * {@link FilenamePolicy} must be set, and unique windows and triggers must produce
 * unique filenames.
 *
...
public class AvroIO {
  ...
  public abstract static class Write<T> extends PTransform<PCollection<T>, PDone> {
    ...
    /** Writes to the file(s) specified by the provided {@link FilenamePolicy}. */
     ...
     *
     * <p>Requires use of {@link #to(FilenamePolicy)}. Filenames will be generated using {@link
     * FilenamePolicy#windowedFilename(FilenamePolicy.WindowedContext)}. See also {@link
