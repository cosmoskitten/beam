 ...
 *
 * <p>Each subclass accepts a user-defined function that takes in {@code InputT} and returns
 * {@code IntermediateT}. Each subclass also defines an {@code emitOutput} function that
 * outputs one or more {@code OutputT} elements based on the input element and result of applying
 * the user-defined function.
 *   Each subclass defines some {@code IntermediateT}, accepting a function that transforms input
 * elements to {@code IntermediateT} and overriding the {@code emitOutput} function for handling
 * what should be sent to the output receiver based on input and a particular {@code IntermediateT}
 * value.
 */
