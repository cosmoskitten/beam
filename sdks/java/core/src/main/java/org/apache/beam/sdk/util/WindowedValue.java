...
public abstract class WindowedValue<T> {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(getValue(), getTimestamp(), getWindows(), getPane());
  }
  ...
  private static class TimestampedValueInGlobalWindow<T>
    ...
    public boolean equals(Object o) {
      if (o instanceof TimestampedValueInGlobalWindow) {
        ...
        return this.getTimestamp().isEqual(that.getTimestamp()) // don't compare chronology objects
    ...
    public boolean equals(Object o) {
      if (o instanceof TimestampedValueInSingleWindow) {
        ...
        return Objects.equals(that.getValue(), this.getValue())
            && this.getTimestamp().isEqual(that.getTimestamp()) // don't compare chronology objects
            && Objects.equals(that.getPane(), this.getPane())
  ...
  private static class TimestampedValueInMultipleWindows<T>
    ...
    public boolean equals(Object o) {
      if (o instanceof TimestampedValueInMultipleWindows) {
        ...
        if (this.getTimestamp().isEqual(that.getTimestamp()) // don't compare chronology objects
            && Objects.equals(that.getValue(), this.getValue())
            && Objects.equals(that.getPane(), this.getPane())) {
