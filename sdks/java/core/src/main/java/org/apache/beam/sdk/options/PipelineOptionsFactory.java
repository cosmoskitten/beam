...
public class PipelineOptionsFactory {
   ...
   */
  private static boolean isCollectionOrArrayOfAllowedTypes(
      Class<?> returnType, JavaType genericReturnType) {

    Class<?> containerType = returnType.equals(ValueProvider.class)
        ? genericReturnType.containedType(0).getRawClass() : returnType;
    ...
    if (Collection.class.isAssignableFrom(containerType)) {
      JavaType innerType = returnType.equals(ValueProvider.class)
          ? genericReturnType.containedType(0).containedType(0)
          : genericReturnType.containedType(0);
