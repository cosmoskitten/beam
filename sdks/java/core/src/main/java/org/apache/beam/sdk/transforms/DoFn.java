...
public abstract class DoFn<InputT, OutputT> implements Serializable, HasDisplayData {
  ...
  private static final ProcessContinuation PROCESS_CONTINUATION_STOP =
      new AutoValue_DoFn_ProcessContinuation(false, Duration.ZERO, Optional.<Instant>absent());
  ...
  public abstract static class ProcessContinuation {
    ...
    public static ProcessContinuation resume() {
      return new AutoValue_DoFn_ProcessContinuation(
          true, Duration.ZERO, Optional.<Instant>absent());
    }
     ...
     */
    public abstract Optional<Instant> futureOutputWatermark();
    ...
    public ProcessContinuation withFutureOutputWatermark(Instant futureOutputWatermark) {
      return new AutoValue_DoFn_ProcessContinuation(
          shouldResume(), resumeDelay(), Optional.of(futureOutputWatermark));
    }
  }
