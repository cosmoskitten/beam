...
public abstract class DoFn<InputT, OutputT> implements Serializable, HasDisplayData {
  ...
  public abstract static class ProcessContinuation {
    ...
    /**
     * A hint that is provided to runners about when execution of this element and
     * restriction pair should be scheduled. Runners will attempt to treat this as a lower
     * bound but may choose not to do so. By default, the execution should be scheduled
     * immediately.
     */
