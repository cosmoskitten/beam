...
public abstract class DoFn<InputT, OutputT> implements Serializable, HasDisplayData {
   ...
   */
  public abstract class TimestampedContext {
    /**
   ...
   */
  public abstract class ProcessContext extends TimestampedContext {
   ...
   */
  public abstract class OnTimerContext extends TimestampedContext {
   ...
   * be shifted backward in {@link TimestampedContext#outputWithTimestamp}.
   *
