...
public abstract class DoFn<InputT, OutputT> implements Serializable, HasDisplayData {
   ...
   * {@link ProcessElement}.
   */
  public interface Arguments<InputT, OutputT> {
    /**
  ...
  /** For testing only, this {@link Arguments} returns {@code null} for all parameters. */
  public static class FakeArguments<InputT, OutputT>
