 ...
 *     ]}</pre>
 *
 * Note that the set of pipeline options required is specific to the runner.
 *
 * Jars containing the SDK, test and runner classes must be available on the classpath (e.g., by
