...
public class WriteFiles<UserT, DestinationT, OutputT>
  ...
  private WriteFilesResult<DestinationT> createWrite(PCollection<UserT> input) {
    ...
    if (windowedWrites) {
      ...
      // would give. So, we use a reshuffle.
      outputFilenames =
          results
              .apply("Reshuffle", Reshuffle.<FileResult<DestinationT>>viaRandomKey())
              .apply(
                  "FinalizeWindowed",
                  ParDo.of(new DoFn<FileResult<DestinationT>, KV<DestinationT, String>>() {
                      ...
                      public void processElement(ProcessContext c) {
                        ...
                        if (fixedNumShards == null && fixedNumShardsView != null) {
                          fixedNumShards = c.sideInput(fixedNumShardsView);
                        }
                      }
                ...
                .withSideInputs(
                    fixedNumShardsView == null
                        ...
                        : ImmutableList.of(fixedNumShardsView)))
                  ...
                  ParDo.of(new DoFn<Void, KV<DestinationT, String>>() {
                      ...
                      public void processElement(ProcessContext c) throws Exception {
                        ...
                        Integer fixedNumShards =
                            (fixedNumShardsView == null)
                                ? null
                                : c.sideInput(fixedNumShardsView);
                        Set<ResourceId> tempFiles = Sets.newHashSet();
