 ...
 * {@link DoFn.ProcessContext#output(Object)}, while an element is added to any additional output
 * {@link PCollection} using {@link DoFn.ProcessContext#output(TupleTag, Object)}. For example:
 *
 * <pre>{@code
 * PCollection<String> words = ...;
