...
public class ParDo {
  ...
  /**
   * Perform commonvalidations of the {@link DoFn} against the input {@link PCollection}, for
  ...
  private static void validateWindowTypeForMethod(TypeDescriptor<? extends BoundedWindow> actualWindowT,
