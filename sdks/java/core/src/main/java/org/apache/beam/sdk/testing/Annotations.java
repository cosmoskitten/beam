...
public class Annotations {
  ...
  public static class Predicates {
    ...
    public static Predicate<Annotation> isAnnotationOfType(final Class<? extends Annotation>
                                                               clazz) {
    ...
    public static Predicate<Annotation> isCategoryOf(final Class<?> value,
                                                     final boolean allowDerived) {
      return new Predicate<Annotation>() {
