...
public class GcsUtil {
  ...
  public void copy(List<String> srcFilenames, List<String> destFilenames) throws IOException {
    checkArgument(
        ...
        srcFilenames.size(),
        destFilenames.size());
    ListeningExecutorService executor = makeFixedExitingListeningExecutorService();
    ...
    try {
      ...
      throw new IOException("Error copying files", e);
    }
  }

  private static ListeningExecutorService makeFixedExitingListeningExecutorService() {
  ...
  public void remove(Collection<String> filenames) throws IOException {
    ...
    try {
      ...
      Thread.currentThread().interrupt();
      throw new IOException("Interrupted while deleting files", e);
    } catch (ExecutionException e) {
      throw new IOException("Error deleting files", e);
    }
  }
