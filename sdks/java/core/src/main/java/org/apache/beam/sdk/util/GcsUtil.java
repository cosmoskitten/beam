...
public class GcsUtil {
    ...
    if (!m.matches()) {
      ...
      try {
        ...
        ResilientOperation.retry(
            ...
            FlexibleBackoff.of().withMaxAttempts(3).withInitialBackoff(Duration.millis(200)),
  ...
  public long fileSize(GcsPath path) throws IOException {
    return fileSize(
        path,
        FlexibleBackoff.of().withMaxAttempts(4).withInitialBackoff(Duration.millis(200)),
        Sleeper.DEFAULT);
  }
