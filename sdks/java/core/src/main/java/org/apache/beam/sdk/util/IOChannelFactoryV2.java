...
public interface IOChannelFactoryV2 {
  ...
  // D. Bulk operation.
  // Returns failed uris.
  Set<String> bulkDelete(Collection<String> uris);

  // Unused Map<String, String> bulkCopy(Map<String, String> uris);
  Map<String, String> bulkRename(Map<String, String> uris);
  // Returns succeeded uris and their Metadata.
  // Unused Collection<Collection<Metadata>> getBulkMetadata(List<String> globs);
