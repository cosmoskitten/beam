...
public class Watch {
  ...
  public abstract static class Growth<InputT, OutputT>
     ...
     * and {@link #allOf}. Users can also develop custom termination conditions, for example,
     * one might imagine a condition that terminates after a given time after the first output
     * appears for the input (unlike {@link #afterTotalOf} which operates relative to when the
     * input itself arrives).
     *
  ...
  static class GrowthState<OutputT> {
    ...
    GrowthState(
        ...
        @Nullable Growth.TerminationCondition terminationCondition,
