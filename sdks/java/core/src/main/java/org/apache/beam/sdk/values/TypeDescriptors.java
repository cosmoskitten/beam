...
public class TypeDescriptors {
   ...
   *   or {@code null} if the variable was type-erased.
   */
  ...
  public static <T, V> TypeDescriptor<V> extractFromTypeParameters(
    ...
    TypeDescriptor<?> extractorSupertype = TypeDescriptor.of(extractor.getClass())
        .getSupertype(TypeVariableExtractor.class);
    ...
    TypeDescriptor<TypeVariableExtractor<T, V>> extractorT =
        extractorSupertype.where(inputT, supertypeDescriptor);
   ...
   * Java type erasure: may return {@code null} if the type was erased.
   */
  @Nullable
