...
public class AutoValueUtils {
  ...
  /** Try to find an accessible constructor for creating an AutoValue class. Otherwise return
   * null.
   */
  ...
  /** Try to find an accessible builder class for creating an AutoValue class. Otherwise return
   * null.
   */
