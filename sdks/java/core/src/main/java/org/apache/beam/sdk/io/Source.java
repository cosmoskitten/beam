...
public abstract class Source<T> implements Serializable, HasDisplayData {
   ...
   *
   * <p>If this throws {@link CannotProvideCoderException}, the user will need to explicitly set
   * a coder on the result of {@link Read#from}.
   */
  public abstract Coder<T> getDefaultOutputCoder() throws CannotProvideCoderException;
