...
public class AvroSource<T> extends BlockBasedSource<T> {
  ...
  public void validate() {
    ...
    if (parseFn == null) {
      ...
      checkNotNull(outputCoder, "output coder must be specified when using a parse fn");
      checkArgument(
          readerSchemaString == null, "schema must not be specified when using a parse fn");
    }
  }
