...
public class Combine {
  ...
  public abstract static class BinaryCombineIntegerFn extends CombineFn<Integer, int[], Integer> {
    ...
    private final class ToIntegerCodingFunction
    ...
    private final class FromIntegerCodingFunction
  ...
  public abstract static class BinaryCombineLongFn extends CombineFn<Long, long[], Long> {
    ...
    private final class ToLongCodingFunction
    ...
    private final class FromLongCodingFunction
        implements DelegateCoder.CodingFunction<Long, long[]> {
      @Override
  ...
  public abstract static class BinaryCombineDoubleFn extends CombineFn<Double, double[], Double> {
    ...
    private final class ToDoubleCodingFunction implements DelegateCoder.CodingFunction<double[], Double> {
      @Override
    ...
    private final class FromDoubleCodingFunction implements DelegateCoder.CodingFunction<Double, double[]> {
      @Override
