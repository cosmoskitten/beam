...
/** A sharded file which is not numbered. */
public class UnnumberedShardedFile implements ShardedFile {

  private static final Logger LOG = LoggerFactory.getLogger(UnnumberedShardedFile.class);
  ...
  /** Constructs an {@link UnnumberedShardedFile} for the given file pattern. */
  public UnnumberedShardedFile(String filePattern) {
  ...
  public String toString() {
    return String.format("unnumbered sharded file with pattern: %s", filePattern);
  }
