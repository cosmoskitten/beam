 ...
 *
 * <p>Restriction trackers which can provide an estimate for the known amount of outstanding
 * work should implement {@link Backlogs.HasBacklog} to provide information that can be
 * used during progress reporting and splitting by runners to improve the performance of the
 * pipeline and increase resource utilization. See <a
