...
public class PAssert {
  ...
  public interface IterableAssert<T> {
    ...
    /**
     * Creates a new {@link IterableAssert} with the assertion restricted to only
     * run on the provided window across all panes that were produced by the arrival of late data.
     *
     * @return a new {@link IterableAssert} like this one but with the assertion only applied to the
     *     specified window.
     */
  ...
  public interface SingletonAssert<T> {
    ...
    /**
     * Creates a new {@link SingletonAssert} with the assertion restricted to
     * only run on the provided window, running the checker only on late panes for each key.
     *
     * @return a new {@link SingletonAssert} like this one but with the assertion only applied to
     *     the specified window.
     */
