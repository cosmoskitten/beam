...
public class Max {
  ...
  Combine.Globally<T, T> globally() {
    return Combine.<T, T>globally(Max.<T>naturalOrder()).named("Max.Globally");
  }
  ...
  Combine.PerKey<K, T, T> perKey() {
    return Combine.<K, T, T>perKey(Max.<T>naturalOrder()).named("Max.PerKey");
  }
  ...
  Combine.Globally<T, T> globally(ComparatorT comparator) {
    return Combine.<T, T>globally(Max.<T, ComparatorT>of(comparator)).named("Max.Globally");
  }
  ...
  Combine.PerKey<K, T, T> perKey(ComparatorT comparator) {
    return Combine.<K, T, T>perKey(Max.<T, ComparatorT>of(comparator)).named("Max.PerKey");
  }
