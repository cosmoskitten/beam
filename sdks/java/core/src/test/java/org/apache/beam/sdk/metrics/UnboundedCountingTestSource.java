...
public class UnboundedCountingTestSource extends
  ...
  static class CountingCheckpointMarkCoder extends StructuredCoder<CountingCheckpointMark> {
    @Override
    public void encode(CountingCheckpointMark value, OutputStream outStream,
                       Context context) throws CoderException, IOException {
      VarLongCoder.of().encode(value.index, outStream, context);
    }

    @Override
    public CountingCheckpointMark decode(InputStream inStream,
                                         Context context) throws CoderException, IOException {
      return new CountingCheckpointMark(VarLongCoder.of().decode(inStream, context));
    }
