...
public class DoFnInvokersTest {
  ...
  @Mock private Arguments<String, String> arguments;
  ...
  public void setUp() {
    ...
    when(arguments.window()).thenReturn(mockWindow);
    when(arguments.inputProvider()).thenReturn(mockInputProvider);
    when(arguments.outputReceiver()).thenReturn(mockOutputReceiver);
    when(arguments.windowingInternals()).thenReturn(mockWindowingInternals);
    when(arguments.processContext(Matchers.<DoFn>any())).thenReturn(mockProcessContext);
  }

  private ProcessContinuation invokeProcessElement(DoFn<String, String> fn) {
    return DoFnInvokers.invokerFor(fn).invokeProcessElement(arguments);
  }
  ...
  public void testDoFnWithState() throws Exception {
    ...
    when(arguments.state(stateId)).thenReturn(mockState);
  ...
  public void testDoFnWithTimer() throws Exception {
    ...
    when(arguments.timer(timerId)).thenReturn(mockTimer);
  ...
  public void testSplittableDoFnWithAllMethods() throws Exception {
    ...
    assertEquals(
        ...
        invoker.invokeProcessElement(
            new FakeArguments<String, String>() {
              @Override
  ...
  public void testSplittableDoFnDefaultMethods() throws Exception {
    ...
    assertEquals(
        ProcessContinuation.stop(), invoker.invokeProcessElement(arguments));
  }
  ...
  public void testProcessElementException() throws Exception {
    ...
    invoker.invokeProcessElement(new FakeArguments<Integer, Integer>() {
      @Override
  ...
  public void testProcessElementExceptionWithReturn() throws Exception {
    ...
    DoFnInvokers
        ...
        .invokeProcessElement(new FakeArguments<Integer, Integer>());
  }
  ...
  public void testOldDoFnProcessElement() throws Exception {
    new DoFnInvokers.OldDoFnInvoker<>(mockOldDoFn)
        .invokeProcessElement(arguments);
