...
public class PathUtilsTest {
  ...
  public void testResolveSinglePath() throws Exception {
    ...
    assertEquals(expected, PathUtils.resolve(tmpFolder.getRoot().toString(), "aa"));
  }
  ...
  public void testResolveMultiplePaths() throws Exception {
    ...
    assertEquals(expected,
        PathUtils.resolve(tmpFolder.getRoot().getPath(), "aa/", "bb/", "cc/"));
  }
  ...
  public void testResolve() throws Exception {
    ...
    assertEquals(expected, PathUtils.resolve(rootString, "aa"));
    assertEquals(expected, PathUtils.resolve("file:" + rootString, "aa"));
    assertEquals(expected, PathUtils.resolve("file://" + rootString, "aa"));
  }
  ...
  public void testResolveOtherIsFullPath() throws Exception {
    ...
    assertEquals(expected, PathUtils.resolve(expected, expected));
  }

  @Test
  public void testResolveOtherIsEmptyPath() throws Exception {
    String expected = tmpFolder.getRoot().getPath();
    assertEquals(expected, PathUtils.resolve(expected, ""));
  }
