...
/**
 * Tests for {@link LocalResourceIdentifier}.
 */
@RunWith(JUnit4.class)
public class LocalResourceIdentifierTest {
  ...
  public void testResolveNormalization() throws Exception {
    ...
    //
    // Normalization is the implementation choice of LocalResourceIdentifier,
    // and it is not required by ResourceIdentifier.resolve().
    assertEquals(
  ...
  private LocalResourceIdentifier toResourceIdentifier(String str) throws Exception {
    boolean isDirectory;
    if (SystemUtils.IS_OS_WINDOWS) {
    ...
    return LocalResourceIdentifier.fromPath(Paths.get(str), isDirectory);
  }
}
