...
public class LocalFileSystemTest {
  ...
  public void testMatchNewResource() throws Exception {
    LocalResourceId fileResource =
        localFileSystem
            .matchNewResource("file://some/test/resource/path", false /* isDirectory */);
    LocalResourceId dirResource =
        localFileSystem
            .matchNewResource("file://some/test/resource/path", true /* isDirectory */);
    ...
    assertThat(
        fileResource.getCurrentDirectory().resolve(
            "path", StandardResolveOptions.RESOLVE_DIRECTORY),
        equalTo(dirResource.getCurrentDirectory()));
    assertThat(dirResource.toString(), equalTo("file://some/test/resource/path/"));
  }
