...
public class DisplayDataEvaluatorTest implements Serializable {
  ...
  public void testDisplayDataForPrimitiveTransforms() {
    ...
    assertThat(displayDatas, not(hasItem(hasDisplayItem("compositeKey", "compositeValue"))));
    assertThat(displayDatas, hasItem(hasDisplayItem("primitiveKey", "primitiveValue")));
  }
}
