...
public class TestPipelineEnforcementsTest implements Serializable {
  ...
  public static class RunnableTestPipelineTests {
    ...
    public void testMissingRunAutoAdd_runnableOnService_expectNoException()
      ...
      // have the the pipeline.run() auto-added
    }
  ...
  private static List<Object[]> extractTests(final Class<?> testClass) {
    final ArrayList<Description> testDescriptions = Request.aClass(testClass)
                                                           .getRunner()
                                                           .getDescription()
                                                           .getChildren();

    return FluentIterable.from(testDescriptions)
                         .transform(new Function<Description, Object[]>() {
