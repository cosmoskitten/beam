...
public class CoderRegistryTest {
  ...
  public void testRegisterInstantiatedCoder() throws Exception {
    ...
    registry.registerCoderFactory(
        CoderFactories.forCoder(TypeDescriptor.of(MyValue.class), MyValueCoder.of()));
  ...
  public void testSimpleUnknownDefaultCoder() throws Exception {
    ...
    thrown.expectMessage(allOf(
        ...
        containsString("Unable to provide a default Coder for")));
  ...
  public void testTypeVariableErrorMessage() throws Exception {
    ...
    thrown.expect(CannotProvideCoderException.class);
    thrown.expectMessage("Unable to provide a default Coder");
