...
public class FlatMapElementsTest implements Serializable {
  ...
  public void testFlatMapWithExceptionsMap() throws Exception {
    ...
    Result<PCollection<Integer>, KV<Integer, Map<String, String>>> result = pipeline
  ...
  /** Test of {@link FlatMapElements#withExceptions()} with a {@link SimpleFunction} and no {@code into}
   * call.
   */
  @Test
  @Category(NeedsRunner.class)
  ...
  public void testFlatMapWithExceptionsDisplayData() {
    ...
    FlatMapElements.FlatMapWithExceptions<?, ?, ?> mapWithExceptions = FlatMapElements
        .via(inferableFn)
        .withExceptions()
