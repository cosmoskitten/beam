...
public class InterceptingUrlClassLoader extends ClassLoader {
    ...
    private InterceptingUrlClassLoader(final ClassLoader parent,
                                       final com.google.common.base.Predicate<String> predicate) {
        this(parent, (Predicate<String>) predicate::apply);
    }

    public InterceptingUrlClassLoader(final ClassLoader parent, final String... ownedClasses) {
        this(parent, Predicates.in(Sets.newHashSet(ownedClasses)));
    }
