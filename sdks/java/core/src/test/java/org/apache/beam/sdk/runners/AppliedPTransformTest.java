...
public class AppliedPTransformTest {
  ...
  public void testEquals() {
    ...
    // The two Create applications have the same name, transform, inputs, and outputs, but are
    ...
    assertThat(disCreate.getOutputs(), equalTo(datCreate.getOutputs()));
    ...
    AppliedPTransform firstIdentityApplication =
        AppliedPTransform.of(
            "Identity", Collections.emptyMap(), Collections.emptyMap(), firstIdentity, disPipeline);
