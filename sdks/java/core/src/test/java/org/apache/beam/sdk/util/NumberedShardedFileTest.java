...
public class NumberedShardedFileTest {
  ...
  public void testReadMultipleShards() throws Exception {
    ...
    NumberedShardedFile shardedFile = new NumberedShardedFile(
        FileSystems.resolveAgainstDirectory(tmpFolder.getRoot().getPath(), "result-*"));
  ...
  public void testReadEmpty() throws Exception {
    ...
    NumberedShardedFile shardedFile = new NumberedShardedFile(
        FileSystems.resolveAgainstDirectory(tmpFolder.getRoot().getPath(), "*"));
  ...
  public void testReadCustomTemplate() throws Exception {
    ...
    NumberedShardedFile shardedFile = new NumberedShardedFile(
        FileSystems.resolveAgainstDirectory(tmpFolder.getRoot().getPath(), "*"), customizedTemplate);
