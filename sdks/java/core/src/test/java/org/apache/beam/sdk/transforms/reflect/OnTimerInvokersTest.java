...
public class OnTimerInvokersTest {
  ...
  @Mock private Arguments<String, String> mockArguments;

  @Before
  public void setUp() {
    MockitoAnnotations.initMocks(this);
    when(mockArguments.window()).thenReturn(mockWindow);
  }

  private void invokeOnTimer(DoFn<String, String> fn, String timerId) {
    OnTimerInvokers.forTimer(fn, timerId).invokeOnTimer(mockArguments);
  }
