...
public class WindowingStrategiesTest {
  ...
  // Since each test spec activates tests for all subsets of its fields, there is little
  // value in having very many - that would just check that nothing is hardcoded and there
  // are not interactions between conversions of fields, or be a redundant test of sub-serializations.
