...
import org.apache.beam.sdk.io.FileBasedSink.DelegatingWritableByteChannel;
...
public class DrunkWritableByteChannelFactory implements WritableByteChannelFactory {
   ...
   */
  private static class DrunkWritableByteChannel extends DelegatingWritableByteChannel {
