...
public class JacksonTransformsTest implements Serializable {
  ...
  public static class FailingObjectMapper extends ObjectMapper {
    @Override
    public <T> T readValue(String content, Class<T> valueType) throws JsonParseException {
      throw new JsonParseException(null, "Fail to read content");
    }

    @Override
    public String writeValueAsString(Object value) throws JsonProcessingException {
      throw new TestJsonProcessingException("Fail to write content\"");
    }
  }
