...
public class MapElementsTest {
  ...
  public void testBuild() {
    ...
    final MapElements map = (MapElements) OperatorTests.getProducer(mapped);
  ...
  public void testTypePropagation() {
    final PCollection<Integer> input = OperatorTests.createMockDataset(TypeDescriptors.integers());
