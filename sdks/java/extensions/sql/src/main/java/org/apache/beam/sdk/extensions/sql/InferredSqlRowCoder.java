...
/**
 * Provides interface to create {@link RowType} and then {@link Row} instances
 * based on the element type.
 *
 * <p>Requires delegate coder to encode original elements.
 */
public class InferredSqlRowCoder<T> extends CustomCoder<T> {
  ...
  public static <V extends Serializable> InferredSqlRowCoder<V> ofSerializable(
    ...
    return of(SerializableCoder.of(elementType), elementType);
  }
