 ...
 * It holds the value, and return it directly during {@link #evaluate(BeamRow, BoundedWindow)}.
 *
 */
public class BeamSqlPrimitive<T> extends BeamSqlExpression {
  ...
  @Override
  public BeamSqlPrimitive<T> evaluate(BeamRow inputRow, BoundedWindow window) {
    return this;
  }
