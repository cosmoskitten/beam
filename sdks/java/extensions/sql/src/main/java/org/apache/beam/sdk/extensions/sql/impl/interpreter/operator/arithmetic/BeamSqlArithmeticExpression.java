...
public abstract class BeamSqlArithmeticExpression extends BeamSqlExpression {
  ...
  @Override public BeamSqlPrimitive<? extends Number> evaluate(Row inputRow,
    ...
    BigDecimal left = SqlFunctions.toBigDecimal((Number) opValueEvaluated(0, inputRow, window));
    BigDecimal right = SqlFunctions.toBigDecimal((Number) opValueEvaluated(1, inputRow, window));
