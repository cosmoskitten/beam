...
public abstract class BeamSqlExpression implements Serializable {
  ...
  public <T> T opValueEvaluated(int idx, BeamRow row, BoundedWindow window) {
  ...
  /**
   * Apply input record {@link BeamRow} with {@link BoundedWindow} to this expression,
   * the output value is wrapped with {@link BeamSqlPrimitive}.
   */
  public abstract BeamSqlPrimitive evaluate(BeamRow inputRow, BoundedWindow window);
