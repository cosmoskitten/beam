...
public class BeamSqlDateCeilExpression extends BeamSqlExpression {
  ...
  public BeamSqlPrimitive evaluate(
    ...
    ReadableInstant date = opValueEvaluated(ReadableInstant.class, 0, inputRow, window, env);
    long time = date.getMillis();
    TimeUnitRange unit = opValueEvaluated(TimeUnitRange.class, 1, inputRow, window, env);
