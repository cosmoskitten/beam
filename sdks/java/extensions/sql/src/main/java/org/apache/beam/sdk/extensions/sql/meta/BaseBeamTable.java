...
public abstract class BaseBeamTable implements BeamSqlTable {
  ...
  @Override
  public abstract PCollection<Row> buildIOReader(PBegin begin);
  ...
  @Override
  public abstract POutput buildIOWriter(PCollection<Row> input);
  ...
  @Override
  public abstract BeamTableStatistics getTableStatistics(PipelineOptions options);
}
