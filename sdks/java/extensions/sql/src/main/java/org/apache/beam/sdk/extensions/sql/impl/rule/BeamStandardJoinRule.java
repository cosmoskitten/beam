...
public class BeamStandardJoinRule extends RelOptRule {
  public static final BeamStandardJoinRule INSTANCE = new BeamStandardJoinRule();

  private BeamStandardJoinRule() {
    super(
        operand(LogicalJoin.class, operand(RelNode.class, any()), operand(RelNode.class, any())),
        RelFactories.LOGICAL_BUILDER,
        "BeamStandardJoinRule");
  }
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    BeamStandardJoinRel rel =
        new BeamStandardJoinRel(
            join.getCluster(),
