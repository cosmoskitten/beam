...
class BeamSqlExample {
  public static void main(String[] args) throws Exception {
    ...
    BeamRecord row1 = BeamRecord.withRecordType(type).withValues(1, "row", 1.0).build();
    BeamRecord row2 = BeamRecord.withRecordType(type).withValues(2, "row", 2.0).build();
    BeamRecord row3 = BeamRecord.withRecordType(type).withValues(3, "row", 3.0).build();
