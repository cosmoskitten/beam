...
public class BeamJoinRel extends Join implements BeamRelNode {
  ...
  private class Transform extends PTransform<PCollectionTuple, PCollection<Row>> {
    ...
    public PCollection<Row> expand(PCollectionTuple inputPCollections) {
      ...
      PCollection<Row> leftRows = inputPCollections.apply(leftRelNode.toPTransform(sqlEnv));
      PCollection<Row> rightRows = inputPCollections.apply(rightRelNode.toPTransform(sqlEnv));
