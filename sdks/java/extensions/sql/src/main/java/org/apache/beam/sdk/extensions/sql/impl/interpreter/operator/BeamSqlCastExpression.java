    ...
    switch (castOutputType) {
      ...
      case DOUBLE:
        return BeamSqlPrimitive.of(SqlTypeName.DOUBLE,
            SqlFunctions.toDouble((Object) opValueEvaluated(index, inputRow, window, correlateEnv)));
      case SMALLINT:
      ...
      case DECIMAL:
        return BeamSqlPrimitive.of(SqlTypeName.DECIMAL,
            SqlFunctions.toBigDecimal((Object) opValueEvaluated(index, inputRow, window, correlateEnv)));
      case FLOAT:
      ...
      case VARCHAR:
        return BeamSqlPrimitive
            .of(SqlTypeName.VARCHAR, opValueEvaluated(index, inputRow, window, correlateEnv).toString());
      case DATE:
        return BeamSqlPrimitive.of(SqlTypeName.DATE,
            toDate(opValueEvaluated(index, inputRow, window, correlateEnv)));
      case TIMESTAMP:
