...
public class JdbcConnection extends CalciteConnectionWrapper {
  ...
  /**
   * Reads the connection properties starting with "beam." (e.g. "beam.runner") and converts them to
   * a map of pipeline options.
   */
   ...
   *
   * <p>Right after creation the default schema is 'beam', and the schema is empty.
   */
   ...
   *
   * <p>Initially Calcite creates a default top level 'beam' schema using {@link
