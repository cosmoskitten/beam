...
public abstract class BeamKafkaTable extends BaseBeamTable implements Serializable {
  ...
  protected BeamKafkaTable(BeamRowSqlType beamSqlRowType) {
    super(beamSqlRowType);
  }

  public BeamKafkaTable(BeamRowSqlType beamSqlRowType, String bootstrapServers,
      List<String> topics) {
    super(beamSqlRowType);
  ...
  public BeamKafkaTable(BeamRowSqlType beamSqlRowType,
