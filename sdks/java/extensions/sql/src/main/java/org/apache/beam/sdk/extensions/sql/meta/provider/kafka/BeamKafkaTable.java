...
public abstract class BeamKafkaTable extends BaseBeamTable implements Serializable {
  ...
  protected BeamKafkaTable(RowSqlType beamSqlRowType) {
    super(beamSqlRowType);
  }

  public BeamKafkaTable(RowSqlType beamSqlRowType, String bootstrapServers,
      List<String> topics) {
    super(beamSqlRowType);
  ...
  public BeamKafkaTable(RowSqlType beamSqlRowType,
