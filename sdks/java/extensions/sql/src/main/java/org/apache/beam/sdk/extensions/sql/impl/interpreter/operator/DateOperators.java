...
public class DateOperators {
   ...
   */
  public static BeamSqlOperator DATETIME_CEIL =
      new BeamSqlOperator() {
        @Override
        public boolean accept(List<BeamSqlExpression> arguments) {
          // TODO(https://issues.apache.org/jira/browse/BEAM-4621)
          // return acceptMonthOrLarger((TimeUnitRange) ((BeamSqlPrimitive) arguments.get(1)).getValue());
          return true;
        }
   ...
   * <p>Only supports months and years.
   */
  public static BeamSqlOperator DATETIME_FLOOR =
      new BeamSqlOperator() {
        @Override
        public boolean accept(List<BeamSqlExpression> arguments) {
          // TODO(https://issues.apache.org/jira/browse/BEAM-4621)
   ...
   * </ul>
   */
  public static BeamSqlOperator EXTRACT = new BeamSqlOperator() {
    @Override
    public boolean accept(List<BeamSqlExpression> arguments) {
