...
public class BeamSqlArithmeticExpressionTest extends BeamSqlFnExecutorTestBase {
  ...
  @Test public void testPlus() {
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    assertEquals(2, new BeamSqlPlusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());

    // integer + long => long
    operands.clear();
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2L, new BeamSqlPlusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.DOUBLE, 1.1));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2.1, new BeamSqlPlusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
  }
  ...
  @Test public void testMinus() {
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    assertEquals(1, new BeamSqlMinusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());

    // integer + long => long
    operands.clear();
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(1L, new BeamSqlMinusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
    ...
    assertEquals(
        2.1F - 1L,
        new BeamSqlMinusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue().floatValue(),
        0.1);
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(1.1, new BeamSqlMinusExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
  }
  ...
  @Test public void testMultiply() {
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    assertEquals(2, new BeamSqlMultiplyExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());

    // integer + long => long
    operands.clear();
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2L, new BeamSqlMultiplyExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.DOUBLE, 2.1));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2.1, new BeamSqlMultiplyExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
  }
  ...
  @Test public void testDivide() {
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 1));
    assertEquals(2, new BeamSqlDivideExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());

    // integer + long => long
    operands.clear();
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2L, new BeamSqlDivideExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.DOUBLE, 2.1));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 1L));
    assertEquals(2.1, new BeamSqlDivideExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
  }
  ...
  @Test public void testMod() {
    ...
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 2));
    assertEquals(1, new BeamSqlModExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());

    // integer + long => long
    operands.clear();
    operands.add(BeamSqlPrimitive.of(SqlTypeName.INTEGER, 3));
    operands.add(BeamSqlPrimitive.of(SqlTypeName.BIGINT, 2L));
    assertEquals(1L, new BeamSqlModExpression(operands).evaluate(row, null, ImmutableMap.of()).getValue());
