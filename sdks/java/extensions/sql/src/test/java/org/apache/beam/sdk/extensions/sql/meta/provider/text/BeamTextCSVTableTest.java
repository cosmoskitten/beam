...
public class BeamTextCSVTableTest {
  ...
  @Test public void testBuildIOReader() {
    PCollection<Row> rows = new BeamTextCSVTable(buildBeamSqlRowType(),
  ...
  private static RowSqlType buildBeamSqlRowType() {
    return CalciteUtils.toRowType(buildRelDataType());
  }

  private static Row buildRow(Object[] data) {
    return new Row(buildBeamSqlRowType(), Arrays.asList(data));
  }
}
