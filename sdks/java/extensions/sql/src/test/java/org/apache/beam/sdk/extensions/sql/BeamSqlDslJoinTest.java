...
public class BeamSqlDslJoinTest {
  ...
  private static final Schema SOURCE_ROW_TYPE =
      Schema.builder()
          .addField(Schema.Field.nullable("order_id", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("site_id", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("price", Schema.FieldType.INT32))
          .build();
  ...
  private static final Schema RESULT_ROW_TYPE =
      Schema.builder()
          ...
          .addField(Schema.Field.nullable("site_id", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("price", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("order_id0", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("site_id0", Schema.FieldType.INT32))
          .addField(Schema.Field.nullable("price0", Schema.FieldType.INT32))
          .build();
