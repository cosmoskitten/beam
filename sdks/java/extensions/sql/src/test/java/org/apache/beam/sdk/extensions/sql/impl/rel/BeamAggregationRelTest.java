...
public class BeamAggregationRelTest extends BaseRelTest {
  ...
  private RowRateWindow getEstimateOf(String sql) {
    ...
    return BeamSqlRelUtils.getRowRateWindow(root, root.getCluster().getMetadataQuery());
  }

  @Test
  public void testRowRateWindow() {
    String sql = "SELECT order_id FROM ORDER_DETAILS_BOUNDED " + " GROUP BY order_id ";

    RowRateWindow estimate = getEstimateOf(sql);
  ...
  @Test
  public void testRowRateWindowEffectOfGroupSet() {
    ...
    RowRateWindow estimate1 = getEstimateOf(sql1);

    RowRateWindow estimate2 = getEstimateOf(sql2);
  ...
  @Test
  public void testRowRateWindowUnboundedWindow() {
    String sql =
    ...
    RowRateWindow estimate1 = getEstimateOf(sql);
  ...
  @Test
  public void testRowRateWindowSlidingWindow() {
    String sql =
        "select order_id, sum(site_id) as sum_site_id FROM ORDER_DETAILS_UNBOUNDED "
