...
public class BeamSqlDslAggregationTest extends BeamSqlDslBase {
  ...
  private void runAggregationWithoutWindow(PCollection<BeamRecord> input) throws Exception {
    ...
    record.addField("getFieldCount", 4L);
