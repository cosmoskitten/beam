...
public class BigQueryUtilsTest {
  private static final Schema FLAT_TYPE = RowSqlTypes
      .builder()
      .withBigIntField("id")
  ...
  private static final Schema ARRAY_TYPE = RowSqlTypes
      .builder()
      .withArrayField("ids", SqlTypeName.BIGINT)
      .build();

  private static final Schema ROW_TYPE = RowSqlTypes
      .builder()
      .withRowField("row", FLAT_TYPE)
      .build();

  private static final Schema ARRAY_ROW_TYPE = RowSqlTypes
      .builder()
