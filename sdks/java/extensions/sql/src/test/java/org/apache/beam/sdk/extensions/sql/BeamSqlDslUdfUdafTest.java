...
public class BeamSqlDslUdfUdafTest extends BeamSqlDslBase {
  ...
  public void testUdaf() throws Exception {
    ...
    BeamRecord record = BeamRecord.withRecordType(resultType).withValues(0, 30).build();
  ...
  public void testUdf() throws Exception{
    ...
    BeamRecord record = BeamRecord.withRecordType(resultType).withValues(2, 8).build();
