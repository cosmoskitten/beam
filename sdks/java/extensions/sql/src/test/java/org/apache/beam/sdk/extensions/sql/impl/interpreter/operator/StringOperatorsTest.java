  ...
  public static class TrimTest {
    ...
    public void testLeading() throws Exception {
      assertThat(
          StringOperators.TRIM.apply(
              ImmutableList.of(BeamSqlPrimitive.of(SqlTypeName.SYMBOL, SqlTrimFunction.Flag.LEADING),
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "he"),
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "hehe__hehe"))).getValue(),
          equalTo("__hehe"));
    }
    ...
    public void testDefault() {
      assertThat(
          StringOperators.TRIM.apply(
              ImmutableList.of(
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, " hello "))).getValue(),
          equalTo("hello"));
    }
  }
    ...
    public void testApply() throws Exception {
      assertThat(
          StringOperators.CONCAT.apply(
              ImmutableList.of(
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "hello"),
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, " world"))).getValue(),
          equalTo("hello world"));
    }
    ...
    public void testBasic() {
      assertThat(
          StringOperators.POSITION.apply(
              ImmutableList.of(
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "hello"),
                  BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "worldhello"))).getValue(),
          equalTo(5));
    }
  ...
  public static class InitCapTest {
    ...
    public void testTwoWords() {
      assertThat(StringOperators.INIT_CAP.apply(
          ImmutableList.of(
              BeamSqlPrimitive.of(SqlTypeName.VARCHAR, "hello world"))).getValue(),
          equalTo("Hello World"));
    }
