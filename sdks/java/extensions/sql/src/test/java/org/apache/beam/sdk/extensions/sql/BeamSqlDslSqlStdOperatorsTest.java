  ...
  public void testAggrationFunctions() {
    ExpressionChecker checker =
        new ExpressionChecker()
            ...
            .addExprWithNonExactExpectedValue("VAR_POP(c_double)", 0.6666666)
            .addExprWithNonExactExpectedValue("VAR_SAMP(c_double)", 1.0)
            .addExpr("COVAR_POP(c_integer, c_integer_two)", 0)
            .addExpr("COVAR_SAMP(c_integer, c_integer_two)", 1)
            .addExprWithNonExactExpectedValue("COVAR_POP(c_double, c_double_two)", 0.6666666)
            .addExprWithNonExactExpectedValue("COVAR_SAMP(c_double, c_double_two)", 1.0);
