...
public class BeamSqlDslSqlStdOperatorsTest extends BeamSqlBuiltinFunctionsIntegrationTestBase {
  ...
  public void testFloor() {
    ExpressionChecker checker =
        new ExpressionChecker()
            .addExpr("FLOOR(ts TO SECOND)", parseDate("1986-02-15 11:35:26"))
            .addExpr("FLOOR(ts TO MINUTE)", parseDate("1986-02-15 11:35:00"))
            .addExpr("FLOOR(ts TO HOUR)", parseDate("1986-02-15 11:00:00"))
            .addExpr("FLOOR(ts TO DAY)", parseDate("1986-02-15 00:00:00"))
  ...
  public void testCeil() {
    ExpressionChecker checker =
        new ExpressionChecker()
            .addExpr("CEIL(ts TO SECOND)", parseDate("1986-02-15 11:35:26"))
            .addExpr("CEIL(ts TO MINUTE)", parseDate("1986-02-15 11:36:00"))
            .addExpr("CEIL(ts TO HOUR)", parseDate("1986-02-15 12:00:00"))
            .addExpr("CEIL(ts TO DAY)", parseDate("1986-02-16 00:00:00"))
