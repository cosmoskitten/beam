...
public class BeamSqlDslSqlStdOperatorsTest extends BeamSqlBuiltinFunctionsIntegrationTestBase {
  ...
  @SqlOperatorTest(name = "IS NOT NULL", kind = "IS NOT NULL")
  @SqlOperatorTest(name = "IS NULL", kind = "IS NULL")
  @SqlOperatorTest(name = "IS TRUE", kind = "IS TRUE")
  @SqlOperatorTest(name = "IS NOT TRUE", kind = "IS NOT TRUE")
  @SqlOperatorTest(name = "IS FALSE", kind = "IS FALSE")
  @SqlOperatorTest(name = "IS NOT FALSE", kind = "IS NOT FALSE")
  @SqlOperatorTest(name = "IS UNKNOWN", kind = "IS_NULL")
  @SqlOperatorTest(name = "IS NOT UNKNOWN", kind = "IS NOT NULL")
  @SqlOperatorTest(name = "IS DISTINCT FROM", kind = "IS DISTINCT FROM")
  @SqlOperatorTest(name = "IS NOT DISTINCT FROM", kind = "IS NOT DISTINCT FROM")
