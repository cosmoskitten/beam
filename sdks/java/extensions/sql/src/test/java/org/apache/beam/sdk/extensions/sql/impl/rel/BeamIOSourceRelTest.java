...
public class BeamIOSourceRelTest extends BaseRelTest {
  ...
  public void boundedRowCount() {
    ...
    Assert.assertEquals(
        getTable("ORDER_DETAILS_BOUNDED").getRowCount(null).getRowCount(),
        root.estimateRowCount(RelMetadataQuery.instance()),
        0.001);
  }
  ...
  public void unboundedRowCount() {
    ...
    Assert.assertEquals(
        getTable("ORDER_DETAILS_BOUNDED").getRowCount(null).getRate(),
        root.estimateRowCount(RelMetadataQuery.instance()),
        0.001);
  }
}
