...
public class SqlQuery1Test {
  ...
  private static final BeamRow BID1_EUR_RECORD =
      new BeamRow(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID1_EUR));

  private static final BeamRow BID2_EUR_RECORD =
      new BeamRow(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID2_EUR));
