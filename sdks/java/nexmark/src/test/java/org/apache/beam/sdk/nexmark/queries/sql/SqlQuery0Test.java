...
public class SqlQuery0Test {
  ...
  private static final BeamRow BID1_RECORD =
      new BeamRow(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID1));

  private static final BeamRow BID2_RECORD =
      new BeamRow(BID_ADAPTER.getRecordType(), BID_ADAPTER.getFieldsValues(BID2));
