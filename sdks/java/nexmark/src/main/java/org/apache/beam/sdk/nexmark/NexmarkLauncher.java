...
public class NexmarkLauncher<OptionT extends NexmarkOptions> {
  ...
  private Map<NexmarkQueryName, NexmarkQuery> createSqlQueries() {
    return ImmutableMap.<NexmarkQueryName, NexmarkQuery>builder()
        ...
        .put(NexmarkQueryName.CURRENCY_CONVERSION, new NexmarkSqlQuery(configuration, new SqlQuery1()))
        .put(
        ...
        .put(
            NexmarkQueryName.AVERAGE_PRICE_FOR_CATEGORY, new NexmarkSqlQuery(configuration, new SqlQuery5(configuration)))
        .put(
            NexmarkQueryName.HOT_ITEMS, new NexmarkSqlQuery(configuration, new SqlQuery7(configuration)))
        .build();
  }
