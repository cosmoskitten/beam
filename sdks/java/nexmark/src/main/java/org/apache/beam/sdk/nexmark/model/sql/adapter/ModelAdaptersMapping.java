  ...
  private static ModelFieldsAdapter<Person> personAdapter() {
    return new ModelFieldsAdapter<Person>(
        Schema.builder()
            ...
            .addField(Schema.Field.of("dateTime", CalciteUtils.TIME))
  ...
  private static ModelFieldsAdapter<Auction> auctionAdapter() {
    return new ModelFieldsAdapter<Auction>(
        Schema.builder()
            ...
            .addField(Schema.Field.of("dateTime", CalciteUtils.TIMESTAMP))
            .addField(Schema.Field.of("expires", CalciteUtils.TIMESTAMP))
