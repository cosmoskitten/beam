...
public class SplittableProcessElementsRunner<InputT, RestrictionT, OutputT>
  ...
  private FnApiStateAccessor sideInputReader;
  ...
  public void startBundle() {
    this.sideInputReader =
        new FnApiStateAccessor(
            ...
            () -> {
              throw new UnsupportedOperationException("State is not supported by SDF");
            },
            () -> currentWindow);
  ...
  private <PositionT, TrackerT extends RestrictionTracker<RestrictionT, PositionT>>
    ...
    this.currentWindow = elem.getWindows().iterator().next();
