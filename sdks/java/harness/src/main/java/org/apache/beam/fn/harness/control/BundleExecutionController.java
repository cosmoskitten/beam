...
public interface BundleExecutionController {
   ...
   *
   * <p>Allows the processing thread to be taken over by the framework allowing for any arbitrary
   * continuation.
   */
  // TODO: Consider an explicit callback pause/resume mechanism that allows the for a local variable
  // to store and control whether buffering is being performed.
   ...
   * root and unstarted residual root.
   */
  void checkpoint(BundleApplication primaryRoot, DelayedBundleApplication residualRoot);
