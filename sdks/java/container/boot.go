...
func main() {
	...
	cp := []string{
		...
		filepath.Join(jarsDir, "beam-runners-core-java.jar"),
		filepath.Join(jarsDir, "beam-runners-core-construction-java.jar"),
		filepath.Join(jarsDir, "beam-runners-google-cloud-dataflow-java.jar"),
		filepath.Join(jarsDir, "beam-sdks-common-runner-api.jar"),
		filepath.Join(jarsDir, "beam-sdks-common-fn-api.jar"),
		filepath.Join(jarsDir, "netty-transport-native-epoll-linux-x86_64.jar"),
	}
