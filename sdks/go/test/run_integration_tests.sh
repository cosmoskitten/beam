...
echo "Building Dataflow worker jar"
./gradlew :beam-runners-google-cloud-dataflow-java-worker:shadowJar

DATAFLOW_WORKER_JAR=$(find ../../runners/google-cloud-dataflow-java/worker/build/libs/beam-runners-google-cloud-dataflow-java-worker-fnapi-bundled-*.jar)
