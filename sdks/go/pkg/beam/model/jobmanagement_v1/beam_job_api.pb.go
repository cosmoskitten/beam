...
type MetricResults struct {
	Attempted            []*MonitoringInfo `protobuf:"bytes,1,rep,name=attempted,proto3" json:"attempted,omitempty"`
	Committed            []*MonitoringInfo `protobuf:"bytes,2,rep,name=committed,proto3" json:"committed,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *MetricResults) GetAttempted() []*MonitoringInfo {
	if m != nil {
		return m.Attempted
	}
	return nil
...
func (m *MetricResults) GetCommitted() []*MonitoringInfo {
	if m != nil {
		return m.Committed
	}
	return nil
