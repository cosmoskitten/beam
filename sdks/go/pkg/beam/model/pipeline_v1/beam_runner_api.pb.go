...
func (m *Schema_LogicalType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Schema_LogicalType.Merge(m, src)
}
...
func (*Schema_MapType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf57597c3a9659a9, []int{24, 1}
}
...
func (m *Schema_MapType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Schema_MapType.Merge(m, src)
}
...
func (*Schema_FieldType) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf57597c3a9659a9, []int{24, 2}
}
...
func (m *Schema_FieldType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Schema_FieldType.Merge(m, src)
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*Schema_FieldType) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*Schema_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_cf57597c3a9659a9, []int{24, 3}
}
...
func (m *Schema_Field) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Schema_Field.Merge(m, src)
}
