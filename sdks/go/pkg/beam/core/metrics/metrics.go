...
// DumpToLog is a debugging function that outputs all metrics available to
...
// DumpToOut is a debugging function that outputs all metrics available to
// the local worker to std out.
func DumpToOut() {
	metricMu.RLock()
	defer metricMu.RUnlock()
	var pts []string
