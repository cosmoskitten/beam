...
func TestExtractor(t *testing.T) {
	tests := []struct {
		...
		{name: "iters1", files: []string{iters}, pkg: "iters",
			expected: []string{"runtime.RegisterFunction(iterFn)", "runtime.RegisterFunction(iterFn2)", "funcMakerStringIterIntГ", "funcMakerIntSliceOfIterIntГ", "iterMakerInt"},
		},
...
func iterFn(k string, iter func(*int) bool) {}
func iterFn2(k int, iters []func(*int) bool) {}
