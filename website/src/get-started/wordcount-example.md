...
<a class="button button--primary" target="_blank"
  href="https://github.com/apache/beam/blob/master/examples/python/notebooks/get-started/quickstart-java.ipynb">
...
<a class="button button--primary" target="_blank"
  href="https://github.com/apache/beam/blob/master/examples/python/notebooks/get-started/quickstart-go.ipynb">
  View source on GitHub
</a>
