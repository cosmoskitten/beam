...
{% include buttons-code-snippet.md
  notebook="examples/notebooks/documentation/transforms/python/elementwise/flatmap-py.ipynb"
  code="sdks/python/apache_beam/examples/snippets/transforms/elementwise/flatmap.py"
%}
