...
### Example 5: FlatMap with multiple arguments
...
### Example 6: FlatMap with side inputs as singletons
...
### Example 7: FlatMap with side inputs as iterators
...
### Example 8: FlatMap with side inputs as dictionaries
