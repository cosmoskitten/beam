...
<a class="button button--primary" target="_blank"
  href="https://github.com/apache/beam/blob/master/sdks/python/notebooks/io/custom-inputs-filebasedsource.ipynb">
...
<a class="button button--primary" target="_blank"
  href="https://github.com/apache/beam/blob/master/sdks/python/notebooks/io/custom-inputs-boundedsource.ipynb">
  View source on GitHub
</a>
