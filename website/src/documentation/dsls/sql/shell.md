...
```
./gradlew -p sdks/java/extensions/sql/shell -Pbeam.sql.shell.bundled=':runners:flink,:sdks:java:io:kafka' installDist
...
```
./gradlew -p sdks/java/extensions/sql/shell -Pbeam.sql.shell.bundled=':runners:flink,:sdks:java:io:kafka' distZip
