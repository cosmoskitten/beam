...
### Execution Mode
<span class="language-java">This section is not applicable to the Java FnApiRunner.</span>

<span class="language-py">Python FnApiRunner supports multi-threading and multi-processing mode.</span>
