...
to. This is similar to Flink's JobManager. You will still need a JobManager if
you submit against a Flink cluster but Beam's JobService will take care of the
job submission to the JobManager.
</span>
