...
date:   2019-10-01 00:00:01 -0800
# Date above corrected but keep the old URL:
permalink: /blog/2019/10/01/beam-2.16.0.html
...
See the [download page]({{ site.baseurl }}/get-started/downloads/#2160-2019-10-01) for this release.<!--more-->
 ...
 * Fully support Python 3.5, 3.6, 3.7. ([BEAM-1251](https://issues.apache.org/jira/browse/BEAM-1251))
 * Support customized container. ([BEAM-7907](https://issues.apache.org/jira/browse/BEAM-7907))
...
* Write portable Beam application jar. ([BEAM-7966](https://issues.apache.org/jira/browse/BEAM-7966))
* Execute portable Flink application jar. ([BEAM-7967](https://issues.apache.org/jira/browse/BEAM-7967))
...
* BEAM SDK has compatibility problems with go1.13. ([BEAM-7994](https://issues.apache.org/jira/browse/BEAM-7994))
* Remove translation of bounded reads from portable Flink runner. ([BEAM-8010](https://issues.apache.org/jira/browse/BEAM-8010))
* Remove workaround to run unbounded sources in portable pipelines. ([BEAM-8011](https://issues.apache.org/jira/browse/BEAM-8011))
...
* HllCount needs to handle null sketches properly. ([BEAM-8126](https://issues.apache.org/jira/browse/BEAM-8126))
