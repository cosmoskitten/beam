...
https://cwiki.apache.org/confluence/display/BEAM/Contribution+FAQ), and if that doesn't
...
[stackoverflow](https://stackoverflow.com/questions/tagged/apache-beam)
 ...
 https://cwiki.apache.org/confluence/display/BEAM/Contribution+FAQ)
...
1. If you need help with git forking, cloning, branching, committing, pull requests, and squashing commits, see
   [Git workflow tips]({{ site.baseurl }}/contrib/git-workflow/)
...
https://cwiki.apache.org/confluence/display/BEAM/Contribution+FAQ) or ask on
