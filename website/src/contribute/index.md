...
If you have questions, consult the [contribution FAQ]({{ site.baseurl }}/contribute/FAQ), and if that doesn't
...
If you run into any issues, check out the [contribution FAQ]({{ site.baseurl }}/contribute/FAQ) or ask on
