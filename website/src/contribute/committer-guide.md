...
* Avoid keeping in history formatting messages such as checktyle or spotless fixes. Squash them with previous commit and add formatting in the commit message.
