...
//                ' && bash release/src/main/python-release/run_release_candidate_python_quickstart.sh' +
//                ' && bash release/src/main/python-release/run_release_candidate_python_mobile_gaming.sh')
//    }
    steps {
        shell('cd ' + common_job_properties.checkoutDir +
