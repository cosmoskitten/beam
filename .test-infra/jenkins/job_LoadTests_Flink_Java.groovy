...
PhraseTriggeringPostCommitBuilder.postCommitJob(
  ...
  String pythonHarnessImage = infrastructure.prepareSDKHarness(delegate, testConfiguration.sdk, repositoryRoot, 'latest')
  ...
  String jobServerImage = infrastructure.prepareFlinkJobServer(delegate, repositoryRoot, 'latest')
  infrastructure.setupFlinkCluster(delegate, jobName, 2, pythonHarnessImage, jobServerImage)
