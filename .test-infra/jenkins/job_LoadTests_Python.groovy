...
PhraseTriggeringPostCommitBuilder.postCommitJob(
        ...
        def datasetName = loadTestsBuilder.setBQDatasetNameByTriggerContext('load_test', CommonTestProperties.TriggeringContext.PR)
...
CronJobBuilder.cronJob('beam_LoadTests_Python_GBK_Dataflow_Batch', 'H 12 * * *', this) {
        def datasetName = loadTestsBuilder.setBQDatasetNameByTriggerContext('load_test', CommonTestProperties.TriggeringContext.POST_COMMIT)
        loadTestsBuilder.loadTests(delegate, CommonTestProperties.SDK.PYTHON, loadTestConfigurations(datasetName), "GBK", "batch")
}
