...
def testConfiguration5Workers = { datasetName -> [
        [
    ...
    def testConfiguration16Workers = { datasetName -> [
        [
...
def loadTest = { scope, triggeringContext ->
  ...
  loadTestsBuilder.loadTests(scope, sdkName,  testConfiguration5Workers(datasetName), "GBK", "batch")

  numberOfWorkers = 16
  infra.scaleCluster(scope, jenkinsJobName, numberOfWorkers)

  loadTestsBuilder.loadTests(scope, sdkName,  testConfiguration16Workers(datasetName), "GBK", "batch")
