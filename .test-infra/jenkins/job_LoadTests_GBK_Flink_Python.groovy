...
def testConfiguration = { context ->
        [
                ...
                jobProperties: [
                        ...
                        metrics_dataset     : loadTestsBuilder.setBQDatasetNameByTriggerContext('load_test', context),
...
def loadTest = { scope, triggeringContext ->
  ...
  def testConfig = testConfiguration(triggeringContext)
