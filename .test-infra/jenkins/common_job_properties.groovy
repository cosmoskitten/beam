...
class common_job_properties {
  ...
  static def buildPerformanceTest(def context, def argMap) {
    ...
    context.steps {
        ...
        // TODO: Need to remove
        shell('echo $(find /home/jenkins/.local/lib/python2.7/site-packages /usr/lib/python2.7/dist-packages -name virtualenv)')
        // Create a virtualenv for Perfkit benchmark test
        shell('$HOME/.local/bin/virtualenv PerfKitBenchmarker/pkb')
        // Activate virtualenv
