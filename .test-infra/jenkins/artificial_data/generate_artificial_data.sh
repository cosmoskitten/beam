...
echo "The following dependencies have later release versions:" > $WORKSPACE/src/build/dependencyUpdates/test_java_report.txt
echo ' - groupA:artifactA [1.0 -> 4.0]' >> $WORKSPACE/src/build/dependencyUpdates/test_java_report.txt
echo ' - groupB:artifactB [1.0 -> 1.1]' >> $WORKSPACE/src/build/dependencyUpdates/test_java_report.txt
