...
def commonLoadTestConfig = { jobName, streaming ->
    [
            [
            ...
            jobProperties: [
                    ...
                    appName             : "load_tests_Java_Dataflow_${jobName}_Combine_1",
                    tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
                    publishToBigQuery   : true,
                    bigQueryDataset     : 'load_test',
                    bigQueryTable       : "java_dataflow_${jobName}_Combine_1",
                    sourceOptions       : """
                                            {
            ...
            [
                    ...
                    jobProperties: [
                            project             : 'apache-beam-testing',
                            appName             : "load_tests_Java_Dataflow_${jobName}_Combine_2",
                            tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
                            publishToBigQuery   : true,
                            bigQueryDataset     : 'load_test',
                            bigQueryTable       : "java_dataflow_${jobName}_Combine_2",
                            sourceOptions       : """
                                                    {
                                                      "numRecords": 20000000,
                                                      "keySizeBytes": 10,
            ...
            [
                    ...
                    jobProperties: [
                            project             : 'apache-beam-testing',
                            appName             : "load_tests_Java_Dataflow_${jobName}_Combine_3",
                            tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
                            publishToBigQuery   : true,
                            bigQueryDataset     : 'load_test',
                            bigQueryTable       : "java_dataflow_${jobName}_Combine_3",
                            sourceOptions       : """
                                                    {
                                                      "numRecords": 2000,
                                                      "keySizeBytes": 100000,
            ...
            [
                    ...
                    jobProperties: [
                            project             : 'apache-beam-testing',
                            appName             : "load_tests_Java_Dataflow_${jobName}_Combine_4",
                            tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
                            publishToBigQuery   : true,
                            bigQueryDataset     : 'load_test',
                            bigQueryTable       : "java_dataflow_${jobName}_Combine_4",
                            sourceOptions       : """
                                                    {
                                                      "numRecords": 5000000,
                                                      "keySizeBytes": 10,
            ...
            [
                    ...
                    jobProperties: [
                            project             : 'apache-beam-testing',
                            appName             : "load_tests_Java_Dataflow_${jobName}_Combine_5",
                            tempLocation        : 'gs://temp-storage-for-perf-tests/loadtests',
                            publishToBigQuery   : true,
                            bigQueryDataset     : 'load_test',
                            bigQueryTable       : "java_dataflow_${jobName}_Combine_5",
                            sourceOptions       : """
                                                    {
                                                      "numRecords": 5000000,
                                                      "keySizeBytes": 10,
