...
def sortDescByParallelism = { testConfigs ->
    return testConfigs.sort { a, b -> a.jobProperties.parallelism == b.jobProperties.parallelism ? 0 : a.jobProperties.parallelism < b.jobProperties.parallelism ? 1 : -1 }
}
...
def batchLoadTestJob = { scope, triggeringContext ->
    ...
    for (config in testConfigs) {
        infra.scaleCluster(scope, jenkinsJobName, config.jobProperties.parallelism)
