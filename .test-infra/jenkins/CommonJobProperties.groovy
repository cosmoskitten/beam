...
class CommonJobProperties {
  ...
  // maxWorkers set to 12 to avoid jvm oom as in [BEAM-4847].
  static void setGradleSwitches(context, maxWorkers = 12) {
    ...
    // For [BEAM-4847], hardcode Xms and Xmx to reasonable values (1g/8g).
    context.switches("-Dorg.gradle.jvmargs=-Xms1g")
