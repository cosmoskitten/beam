...
@Grapes([
  @Grab(group="com.google.cloud", module="google-cloud-bigquery", version="1.31.0"),
  @Grab(group="joda-time", module="joda-time", version="2.10"),
  @Grab(group="com.google.api", module="api-common", version="1.6.0"),
  @Grab(group="com.fasterxml.jackson", module="jackson-core", version="2.9.5"),
  @Grab(group="com.google.protobuf", module="protobuf-java-util", version="3.5.1"),
  @Grab(group="com.google.protobuf", module="protobuf-java", version="3.5.1"),
  @Grab(group="org.codehaus.jackson", module="jackson-core-asl", version="1.9.13"),
  @Grab(group="com.google.errorprone", module="error_prone_annotations", version="2.3.1")
])
