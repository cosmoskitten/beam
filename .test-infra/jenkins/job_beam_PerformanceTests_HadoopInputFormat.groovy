...
job('beam_PerformanceTests_HadoopInputFormat') {
    ...
    common_job_properties.setupKubernetes(context, namespace, kubeconfig)
    common_job_properties.buildPerformanceTest(context, testArgs)
    common_job_properties.cleanupKubernetes(context, namespace, kubeconfig)
}
