...
python3 -m dependency_check.dependency_check_report_generator_test
python3 -m jira_utils.jira_manager_test
python3 -m dependency_check.version_comparer_test

echo "<html><body>" > $WORKSPACE/src/build/dependencyUpdates/beam-dependency-check-report.html

python3 -m dependency_check/dependency_check_report_generator Python

python3 -m dependency_check.dependency_check_report_generator Java
