...
REPORT_DESCRIPTION="
<h4> In Beam, we make a best-effort attempt at keeping all dependencies up-to-date. </h4>
...
<li> The current version is behind the later version for over 180 days.
  <ul>
    <li> e.g. com.google.auto.service:auto-service 2014-10-24 -> 2017-12-11 </li>
  </ul>
</li>
</ul>

<h4> In the future, issues will be filed and tracked for these automatically, but in the meantime you can search for existing issues or open a new one. </h4>
<h4> Read more about our dependency update policy: <a href=\"https://docs.google.com/document/d/15m1MziZ5TNd9rh_XN0YYBJfYkt0Oj-Ou9g0KFDPL2aA/edit#\"> Beam Dependency Update Policy </a></h4>"
...
echo "$REPORT_DESCRIPTION </body></html>" >> build/dependencyUpdates/beam-dependency-check-report.html
