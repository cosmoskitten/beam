...
PhraseTriggeringPostCommitBuilder.postCommitJob(
    ...
    loadTestsBuilder.loadTests(delegate, CommonTestProperties.SDK.JAVA, loadTestConfigurations, CommonTestProperties.TriggeringContext.PR, "batch")
}

CronJobBuilder.cronJob('beam_LoadTests_Java_GBK_Dataflow_Batch', 'H 12 * * *', this) {
    loadTestsBuilder.loadTests(delegate, CommonTestProperties.SDK.JAVA, loadTestConfigurations, CommonTestProperties.TriggeringContext.POST_COMMIT, "batch")
}
