...
class TestingInfra {
  ...
  static void setupFlinkCluster(def context, String clusterName, Integer workerCount) {
    context.steps {
  ...
  static void teardownDataproc(def context, String clusterName) {
    context.steps {
      shell("gcloud dataproc clusters delete $clusterName")
    }
  }
}