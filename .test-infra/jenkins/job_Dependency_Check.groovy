...
job('beam_Dependency_Check') {
    ...
    def contents = "Test, Test, Test. "

    publishers {
      extendedEmail {
        recipientList('yifanzou@google.com')
        defaultSubject('Beam Dependency Check Email Test')
        defaultContent('Nothing broken, we are good.')
        contentType('text/plain')
        triggers {
          always{
            recipientList('yifanzou@google.com')
            contentType('text/plain')
            subject('Beam Dependency Check Email Test')
            content(contents)
          }
        }
      }
    ...
    steps {
        ...
        gradle {
            ...
            switches('-DreportfileName=JavaDependencyReport')
        }
        ...
        emailContents.add('This is the email content.')
        contents = contents + emailContents.get(0)
    }
}
