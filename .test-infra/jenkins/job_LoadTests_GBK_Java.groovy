...
def loadTestConfigurations = { mode, isStreaming, context ->
    [
            [
                    ...
                    jobProperties: [
                            ...
                            bigQueryDataset       : loadTestsBuilder.setBQDatasetNameByTriggerContext('load_test', context),
...
def streamingLoadTestJob = { scope, triggeringContext ->
  ...
  for (testConfiguration in loadTestConfigurations('streaming', true, triggeringContext)) {
