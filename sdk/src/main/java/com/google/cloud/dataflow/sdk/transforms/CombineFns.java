...
public class CombineFns {
  ...
  /**
   * A tuple of {@link Object Objects} produced for a given key from the composed combine functions.
   */
  public static class CoCombineResult implements Serializable {
     ...
     *
     * @throws NullPointerException if any key or value in {@code mavaluesMapp} is null
     */
    CoCombineResult(
  ...
  public static class ComposedCombineFn<DataT> extends CombineFn<DataT, Object[], CoCombineResult> {
    ...
    @Override
    public Coder<Object[]> getAccumulatorCoder(CoderRegistry registry, Coder<DataT> dataTCoder)
        throws CannotProvideCoderException {
      List<Coder<Object>> coders = Lists.newArrayList();
      for (int i = 0; i < combineFnCount; ++i) {
        Coder<Object> inputCoder =
            registry.getDefaultOutputCoder(extractInputFns.get(i), dataTCoder);
  ...
  public static class ComposedKeyedCombineFn<DataT, K>
    ...
    public Coder<Object[]> getAccumulatorCoder(
        CoderRegistry registry, Coder<K> keyCoder, Coder<DataT> dataTCoder)
        throws CannotProvideCoderException {
      List<Coder<Object>> coders = Lists.newArrayList();
      for (int i = 0; i < combineFnCount; ++i) {
        Coder<Object> inputCoder =
